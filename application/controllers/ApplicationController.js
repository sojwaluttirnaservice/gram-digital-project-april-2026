...
const ApplicationController = {
	...
	renderApplicationPrintsReportPage: asyncHandler(async (req, res) => {
		...
		renderPage(
			res,
			'user/newapplication/application-print-report-new-page.pug',
			{
				applicationsList,
				filterCertificate: cert
			}
	...
	renderApplicationCountReportPage: asyncHandler(async (req, res) => {
		let filters = { ...req.query };

		let [applicationsCount] = await ApplicationModel.getApplicationsCount(
			res.pool,
			filters
		);
		console.log(applicationsCount);

		renderPage(res, 'user/newapplication/application-count-report.pug', {
