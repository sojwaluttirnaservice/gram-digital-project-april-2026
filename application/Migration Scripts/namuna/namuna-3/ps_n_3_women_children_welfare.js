...
const ps_n_3_women_children_welfare = sequelize.define(
    'ps_n_3_women_children_welfare',
    {
        id: {
        ...
        women_child_welfare_10_percent_expense: {
            ...
            allowNull: true,
            comment:
                'महिला बाल कल्याण १० टक्के खर्च करावयाची रक्कम (Amount to be spent on female child welfare, 10% of total)',
        },
    ...
    {
        timestamps: true,
        comment: 'महिला बाल कल्याण १० टक्के खर्च केल्याचा वार्षिक अहवाल',
    }
);

module.exports = ps_n_3_women_children_welfare;