const namuna1Tapshil4AuxiliaryGrantsModel = {
    ...
    updateSingleNamuna1Tapshil4AuxiliaryGrantsHeaderEntry: (pool, updateEntry) => {
        return new Promise((resolve, reject) => {
            const q = `
                UPDATE ps_namuna_1_tapshil_4_deposit_of_auxiliary_grants_headers
                SET
    ...
    updateSingleNamuna1Tapshil4AuxiliaryGrantsEntry: (pool, singleFundEntry) => {
        return new Promise((resolve, reject) => {
            const q = `
                UPDATE ps_namuna_1_tapshil_4_deposit_of_auxiliary_grants
                SET
    ...
    fetchNamuna1Tapshil4AuxiliaryGrantsByHeaderId: (pool, auxiliaryGrantIdFk) => {
        return new Promise((resolve, reject) => {
            const q = `
                ...
                ORDER BY id;
            `;
            pool.query(q, [auxiliaryGrantIdFk], (err, result) => {
                err ? reject(err) : resolve(result);
            });
        });
    },
