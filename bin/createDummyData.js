...
const createDummyData = async () => {
	sequelize
		.sync({ force: true })
		.then(() => {
			ps_pani_kar.bulkCreate([
				{ generalWaterTax: 150, specialWaterTax: 1200 }
			]);
		})
		.then(() => {
		...
		.then(() => {
			ps_gram_panchayet.create({
				...
				gp_contact: '42.303',
				gp_map: 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1862.9067060616396!2d77.8322554176922!3d20.960006985342712!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bd6a3e18508d0e1%3A0x461d0c7c7a99efef!2sMasod%2C%20Maharashtra%20444901!5e0!3m2!1sen!2sin!4v1679130640892!5m2!1sen!2sin',
				gp_info_one:
				...
				gp_dastavegList: JSON.stringify([
					'बक्षिस पत्राने ',
					'खरेदीखत',
					'सोळ हक्काने ',
					'वाटणी पत्रानुसार ',
