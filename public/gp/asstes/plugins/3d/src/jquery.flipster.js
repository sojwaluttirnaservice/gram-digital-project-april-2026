    ...
    var svgNS = "http://www.w3.org/2000/svg",
        svgSupport = (function () {
            ...
            return function () {
                ...
                div.innerHTML = "<svg/>";
                support =
                    div.firstChild && div.firstChild.namespaceURI === svgNS;
                return support;
            };
        })();
    ...
    $.fn.flipster = function (options) {
        ...
        return this.each(function () {
            ...
            function buildButtonContent(dir) {
                var text =
                    dir === "next" ? settings.buttonNext : settings.buttonPrev;
            ...
            function buildNav() {
                ...
                _nav = $(
                    '<ul class="' + classes.nav + '" role="navigation" />',
                );
                _navLinks = $("");
                ...
                _items.each(function (i) {
                    var item = $(this),
                        ...
                        itemTitle =
                            item.data("flip-title") || item.attr("title") || i,
                        navLink = $(
                            '<a href="#" class="' +
                                classes.navLink +
                                '">' +
            ...
            function resize(skipTransition) {
                ...
                _items.each(function (i) {
                    ...
                    if (settings.spacing !== 0) {
                        item.css(
                            "margin-right",
                            width * settings.spacing + "px",
                        );
                    }

                    left = item.position().left;
                    _itemOffsets[i] =
                        -1 * (left + width / 2 - _containerWidth / 2);
                ...
                if (settings.scrollwheel) {
                    ...
                    elem.on("mousewheel.flipster wheel.flipster", function () {
                        ...
                        throttle(function (e) {
                            ...
                            _delta +=
                                e.wheelDelta || (e.deltaY + e.deltaX) * -1; // Invert numbers for Firefox
                ...
                if (settings.touch) {
                    ...
                    elem.on({
                        "touchstart.flipster": function (e) {
                            // e.preventDefault();
                            e = e.originalEvent;
                            _startDragX = e.touches
                                ? e.touches[0].clientX
                                : e.clientX;
                            _startDragY = e.touches
                                ? e.touches[0].clientY
                                : e.clientY;
                        },
            ...
            function init() {
                ...
                style = settings.style
                    ? "flipster--" +
                      settings.style.split(" ").join(" flipster--")
                    : false;
