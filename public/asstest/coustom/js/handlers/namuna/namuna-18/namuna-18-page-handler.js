$(document).ready(function () {
    ...
    $(document).on('click', '#print-namuna-18-btn', function (e) {
        e.preventDefault();
        ...
        if (printType === 'month-year') {
            ...
            window.open(`/namuna/18/print?month=${month}&year=${year}`, '_blank');
        } else {
            ...
            window.open(`/namuna/18/print?fromYear=${fromYear}&toYear=${toYear}`, '_blank');
        }
    });
});
