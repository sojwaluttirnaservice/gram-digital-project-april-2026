// WebcamJS v1.0.12 - http://github.com/jhuckaby/webcamjs - MIT Licensed
(function (e) {
  var t;
  function a() {
  ...
  var Webcam = {
    ...
    attach: function (a) {
      ...
      if (!a) {
        return this.dispatch(
          "error",
          new s("Could not locate DOM element to attach to."),
        );
      }
      this.container = a;
      a.innerHTML = "";
    ...
    savePreview: function (e, t) {
      ...
      e(
        t ? null : s.toDataURL("image/" + a.image_format, a.jpeg_quality / 100),
        s,
        i,
      );
    ...
    snap: function (e, t) {
      ...
      var i = this.params;
      if (!this.loaded)
        return this.dispatch("error", new s("Webcam is not loaded yet"));
      if (!e)
        return this.dispatch(
          "error",
          new s("Please provide a callback function or canvas to snap()"),
        );
      if (this.preview_active) {
      ...
      var h = function () {
        ...
        if (i.crop_width && i.crop_height) {
          ...
          s.drawImage(
            r,
            Math.floor(i.dest_width / 2 - i.crop_width / 2),
            Math.floor(i.dest_height / 2 - i.crop_height / 2),
            i.crop_width,
            i.crop_height,
            0,
            0,
        ...
        e(
          t
            ? null
            : r.toDataURL("image/" + i.image_format, i.jpeg_quality / 100),
          r,
          o,
        );
      };
      if (this.userMedia) {
        ...
        var l = new Image();
        l.onload = h;
        l.src = "data:image/" + this.params.image_format + ";base64," + n;
      }
      return null;
    },
