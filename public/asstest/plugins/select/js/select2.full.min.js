        ...
        if (e) {
          for (
            r = (e = e.split("/")).length - 1,
              y.nodeIdCompat && w.test(e[r]) && (e[r] = e[r].replace(w, "")),
              "." === e[0].charAt(0) &&
                h &&
        ...
        e.define("select2/utils", ["jquery"], function (s) {
          ...
          return (
            ...
            (o.GetData = function (e, t) {
              ...
              return t
                ? o.__cache[n] && null != o.__cache[n][t]
                  ? o.__cache[n][t]
                  : s(e).data(t)
                : o.__cache[n];
            }),
              ...
              (s.prototype.update = function (e) {
                if ((this.clear(), 0 !== e.length)) {
                  for (
                    ...
                    o.id ? (a += o.id) : (a += d.generateChars(4)),
                      s
            ...
            return (
              ...
              (e.prototype.update = function (e, t) {
                if (
                  ...
                  o.attr("title", i()),
                    o.attr("aria-label", i()),
                    o.attr("aria-describedby", n),
                    a.StoreData(o[0], "data", t),
            ...
            return (
              ...
              (n.prototype.select = function (o) {
                ...
                if (
                  ((o.selected = !0),
                  null != o.element &&
                    "option" === o.element.tagName.toLowerCase())
                )
                  return (
                ...
                this.defaults = {
                  ...
                  matcher: function e(t, n) {
                    ...
                    if (n.children && 0 < n.children.length) {
                      for (
                        var i = l.extend(!0, {}, n), o = n.children.length - 1;
                        0 <= o;
                        o--
                      )
