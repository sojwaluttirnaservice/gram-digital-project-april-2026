...
CKEDITOR.lang["fi"] = {
  ...
  forms: {
    ...
    hidden: { title: "Piilokentän ominaisuudet", name: "Nimi", value: "Arvo" },
    select: {
  ...
  language: { button: "Aseta kieli", remove: "Poista kieli" },
  link: {
  ...
  newpage: { toolbar: "Tyhjennä" },
  pagebreak: { alt: "Sivunvaihto", toolbar: "Lisää sivunvaihto" },
  pastetext: {
  ...
  print: { toolbar: "Tulosta" },
  removeformat: { toolbar: "Poista muotoilu" },
  save: { toolbar: "Tallenna" },
  selectall: { toolbar: "Valitse kaikki" },
  showblocks: { toolbar: "Näytä elementit" },
