...
CKEDITOR.lang["af"] = {
  ...
  templates: {
    ...
    selectPromptMsg:
      "Kies die sjabloon om te gebruik in die redigeerder (huidige inhoud gaan verlore):",
  ...
  forms: {
    ...
    textarea: { title: "Teks-area eienskappe", cols: "Kolomme", rows: "Rye" },
    textfield: {
  ...
  newpage: { toolbar: "Nuwe bladsy" },
  pagebreak: { alt: "Bladsy-einde", toolbar: "Bladsy-einde invoeg" },
  pastetext: {
    button: "Voeg by as eenvoudige teks",
    pasteNotification:
      "Druk %1 om by te voeg. Jou leser ondersteun nie byvoeg deur die toolbar knoppie of die konteks kieslys nie",
    title: "Voeg by as eenvoudige teks",
  },
  pastefromword: {
    confirmCleanup:
      "Die teks wat u wil byvoeg lyk asof dit uit Word gekopiëer is. Wil u dit eers skoonmaak voordat dit bygevoeg word?",
    error:
      "Die bygevoegte teks kon nie skoongemaak word nie, weens 'n interne fout",
  ...
  save: { toolbar: "Bewaar" },
  selectall: { toolbar: "Selekteer alles" },
  showblocks: { toolbar: "Toon blokke" },
