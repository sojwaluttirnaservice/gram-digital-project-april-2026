...
CKEDITOR.lang["eo"] = {
  ...
  notification: { closed: "Sciigo fermita" },
  toolbar: {
  ...
  iframe: {
    ...
    noUrl:
      "Bonvolu entajpi la retadreson de la ligilo al la enlinia kadro (IFrame)",
  ...
  language: { button: "Instali lingvon", remove: "Forigi lingvon" },
  link: {
  ...
  newpage: { toolbar: "Nova Paĝo" },
  pagebreak: { alt: "Paĝavanco", toolbar: "Enmeti Paĝavancon por Presado" },
  pastetext: {
  ...
  preview: { preview: "Vidigi Aspekton" },
  print: { toolbar: "Presi" },
  removeformat: { toolbar: "Forigi Formaton" },
  save: { toolbar: "Konservi" },
  selectall: { toolbar: "Elekti ĉion" },
  showblocks: { toolbar: "Montri la blokojn" },
  ...
  widget: { move: "klaki kaj treni por movi", label: "%1 fenestraĵo" },
  uploadwidget: {
