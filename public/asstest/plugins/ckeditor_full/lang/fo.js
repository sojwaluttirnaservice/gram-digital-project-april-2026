...
CKEDITOR.lang["fo"] = {
  ...
  templates: {
    ...
    selectPromptMsg:
      "Vinarliga vel ta skabelón, ið skal opnast í tekstviðgeranum<br>(Hetta yvirskrivar núverandi innihald):",
  ...
  language: { button: "Velja tungumál", remove: "Remove language" },
  link: {
  ...
  newpage: { toolbar: "Nýggj síða" },
  pagebreak: { alt: "Síðuskift", toolbar: "Ger síðuskift" },
  pastetext: {
  ...
  preview: { preview: "Frumsýning" },
  print: { toolbar: "Prenta" },
  removeformat: { toolbar: "Strika sniðgeving" },
  save: { toolbar: "Goym" },
  selectall: { toolbar: "Markera alt" },
  showblocks: { toolbar: "Vís blokkar" },
