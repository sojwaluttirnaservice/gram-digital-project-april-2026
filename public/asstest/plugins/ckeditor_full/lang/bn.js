...
CKEDITOR.lang["bn"] = {
  ...
  templates: {
    ...
    selectPromptMsg:
      "অনুগ্রহ করে এডিটরে ওপেন করার জন্য টেমপ্লেট বাছাই করুন<br>(আসল কনটেন্ট হারিয়ে যাবে):",
  ...
  forms: {
    ...
    textarea: { title: "টেক্সট এরিয়া প্রোপার্টি", cols: "কলাম", rows: "রো" },
    textfield: {
  ...
  preview: { preview: "প্রাকদর্শন" },
  print: { toolbar: "প্রিন্ট করি" },
  removeformat: { toolbar: "ধরন-প্রকৃতি অপসারণ করি" },
  save: { toolbar: "সংরক্ষন করি" },
  selectall: { toolbar: "সব সিলেক্ট করি" },
