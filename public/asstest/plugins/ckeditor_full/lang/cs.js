...
CKEDITOR.lang["cs"] = {
  ...
  bidi: { ltr: "Směr textu zleva doprava", rtl: "Směr textu zprava doleva" },
  blockquote: { toolbar: "Citace" },
  notification: { closed: "Oznámení zavřeno." },
  toolbar: {
  ...
  clipboard: {
    ...
    paste: "Vložit",
    pasteNotification:
      "Stiskněte %1 pro vložení. Váš prohlížeč nepodporuje vkládání pomocí tlačítka na panelu nástrojů nebo volby kontextového menu.",
  ...
  templates: {
    ...
    selectPromptMsg:
      "Prosím zvolte šablonu pro otevření v editoru<br>(aktuální obsah editoru bude ztracen):",
  ...
  language: { button: "Nastavit jazyk", remove: "Odstranit jazyk" },
  link: {
  ...
  pagebreak: { alt: "Konec stránky", toolbar: "Vložit konec stránky" },
  pastetext: {
