...
CKEDITOR.lang["es-mx"] = {
  ...
  common: {
    ...
    invalidCssLength:
      'El valor especificado para el campo "% 1" debe ser un número positivo con o sin una unidad de medida CSS válida (px, %, in, cm, mm, em, ex, pt, or pc).',
    invalidHtmlLength:
      'El valor especificado para el campo "% 1" debe ser un número positivo con o sin una unidad de medición HTML válida (px or %).',
    invalidInlineStyle:
      'El valor especificado para el estilo en línea debe constar de una o más tuplas con el formato de "nombre: valor", separados por punto y coma',
    cssLengthTooltip:
      "Introduzca un número para un valor en píxeles o un número con una unidad CSS válida  (px, %, in, cm, mm, em, ex, pt, or pc).",
  ...
  blockquote: { toolbar: "Entrecomillado" },
  ...
  clipboard: {
    copy: "Copiar",
    copyError:
      "La configuración de seguridad de su navegador no permite al editor ejecutar automáticamente operaciones de copiado. Por favor, utilice el teclado para (Ctrl/Cmd+C).",
    cut: "Cortar",
    cutError:
      "La configuración de seguridad de su navegador no permite al editor ejecutar automáticamente operaciones de corte. Por favor, utilice el teclado para (Ctrl/Cmd+X).",
    paste: "Pegar",
    pasteNotification:
  ...
  flash: {
    access: "Acceso a secuencias de comandos",
    ...
    alignBaseline: "Base",
    alignTextTop: "Texto Arriba",
    bgcolor: "Color de fondo",
    chkFull: "Permitir pantalla completa",
    chkLoop: "Ciclíco",
    chkMenu: "Habilitar menú de flash",
    chkPlay: "Auto reproducción",
    flashvars: "Variables para flash",
    hSpace: "Espacio horizontal",
    properties: "Propiedades del flash",
  ...
  forms: {
    ...
    checkboxAndRadio: {
      checkboxTitle: "Propiedades de la casilla de verificación",
      radioTitle: "Propiedades de botón de opciones",
      value: "Valor",
    ...
    form: {
      ...
      menu: "Propiedades del formulario",
      action: "Acción",
      method: "Método",
    ...
    select: {
      title: "Propiedades del campo de selección",
      selectInfo: "Seleccionar información",
      opAvail: "Opciones disponobles",
      value: "Valor",
      size: "Tamaño",
      lines: "líneas",
    ...
    textarea: {
      title: "Propiedades del área de texto",
      cols: "Columnas",
      rows: "Filas",
    },
    textfield: {
      title: "Propiedades del campo texto",
      name: "Nombre",
      value: "Valor",
      charWidth: "Ancho de caracteres",
  ...
  horizontalrule: { toolbar: "Insertar una línea horizontal" },
  iframe: {
  ...
  indent: { indent: "Incrementar sangría", outdent: "Decrementar sangría" },
  smiley: {
    options: "Opciones de smiley",
    title: "Insertar un smiley",
    toolbar: "Smiley",
  },
  language: { button: "Establecer idioma", remove: "Remover idioma" },
  link: {
  ...
  removeformat: { toolbar: "Remover formato" },
  save: { toolbar: "Guardar" },
  selectall: { toolbar: "Seleccionar todo" },
  showblocks: { toolbar: "Mostrar bloques" },
  sourcearea: { toolbar: "Fuente" },
  specialchar: {
    options: "Opciones de carácteres especiales",
    title: "Seleccione un carácter especial",
    toolbar: "Inserta un carácter especial",
  },
  scayt: {
  ...
  stylescombo: {
    label: "Estilos",
    panelTitle: "Estilos de formatos",
    panelTitle1: "Estilos de bloques",
    panelTitle2: "Estilos de líneas",
    panelTitle3: "Estilo de objetos",
  },
  table: {
  ...
  widget: { move: "Presiona y arrastra para mover", label: "%1 widget" },
  uploadwidget: {
