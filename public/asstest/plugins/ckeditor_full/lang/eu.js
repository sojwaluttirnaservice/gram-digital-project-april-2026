...
CKEDITOR.lang["eu"] = {
  ...
  notification: { closed: "Jakinarazpena itxita." },
  toolbar: {
  ...
  language: { button: "Ezarri hizkuntza", remove: "Kendu hizkuntza" },
  link: {
  ...
  newpage: { toolbar: "Orrialde berria" },
  pagebreak: {
    alt: "Orrialde-jauzia",
  ...
  preview: { preview: "Aurrebista" },
  print: { toolbar: "Inprimatu" },
  removeformat: { toolbar: "Kendu formatua" },
  save: { toolbar: "Gorde" },
  selectall: { toolbar: "Hautatu dena" },
  showblocks: { toolbar: "Erakutsi blokeak" },
  ...
  widget: { move: "Klikatu eta arrastatu lekuz aldatzeko", label: "%1 widget" },
  uploadwidget: {
