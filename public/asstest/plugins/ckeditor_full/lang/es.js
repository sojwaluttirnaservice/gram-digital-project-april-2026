...
CKEDITOR.lang["es"] = {
  ...
  templates: {
    ...
    selectPromptMsg:
      "Por favor selecciona la plantilla a abrir en el editor<br>(el contenido actual se perderá):",
  ...
  language: { button: "Fijar lenguaje", remove: "Quitar lenguaje" },
  link: {
  ...
  newpage: { toolbar: "Nueva Página" },
  pagebreak: { alt: "Salto de página", toolbar: "Insertar Salto de Página" },
  pastetext: {
