...
CKEDITOR.lang["et"] = {
  ...
  common: {
    ...
    invalidLength:
      'Välja "%1" väärtus peab olema positiivne arv korrektse ühikuga (%2) või ilma.',
    invalidCssLength:
  ...
  notification: { closed: "Teavitused on suletud." },
  toolbar: {
  ...
  clipboard: {
    ...
    paste: "Aseta",
    pasteNotification:
      "Asetamiseks vajuta %1. Sinu brauser ei toeta asetamist tööriistariba nupu või kontekstimenüü valikuga.",
  ...
  filetools: {
    ...
    responseError: "Vigane serveri vastus.",
  },
  find: {
    find: "Otsi",
  ...
  language: { button: "Määra keel", remove: "Eemalda keel" },
  link: {
  ...
  newpage: { toolbar: "Uus leht" },
  pagebreak: { alt: "Lehevahetuskoht", toolbar: "Lehevahetuskoha sisestamine" },
  pastetext: {
  ...
  print: { toolbar: "Printimine" },
  removeformat: { toolbar: "Vormingu eemaldamine" },
  save: { toolbar: "Salvestamine" },
  selectall: { toolbar: "Kõige valimine" },
  showblocks: { toolbar: "Blokkide näitamine" },
  ...
  widget: { move: "Liigutamiseks klõpsa ja lohista", label: "%1 vidin" },
  uploadwidget: {
    ...
    uploadMany:
      "Failide üleslaadimine, {current} fail {max}-st üles laaditud ({percentage}%)...",
  },
  wsc: {
    btnIgnore: "Ignoreeri",
