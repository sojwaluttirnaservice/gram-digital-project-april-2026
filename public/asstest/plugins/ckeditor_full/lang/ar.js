...
CKEDITOR.lang["ar"] = {
  ...
  forms: {
    ...
    textarea: { title: "خصائص مساحة النص", cols: "الأعمدة", rows: "الصفوف" },
    textfield: {
  ...
  language: { button: "حدد اللغة", remove: "حذف اللغة" },
  link: {
  ...
  newpage: { toolbar: "صفحة جديدة" },
  pagebreak: { alt: "فاصل الصفحة", toolbar: "إدخال صفحة جديدة" },
  pastetext: {
    button: "لصق كنص بسيط",
    pasteNotification:
  ...
  preview: { preview: "معاينة الصفحة" },
  print: { toolbar: "طباعة" },
  removeformat: { toolbar: "إزالة التنسيقات" },
  save: { toolbar: "حفظ" },
  selectall: { toolbar: "تحديد الكل" },
  showblocks: { toolbar: "مخطط تفصيلي" },
