...
CKEDITOR.lang["da"] = {
  ...
  common: {
    ...
    invalidLength:
      'Værdien angivet for feltet "%1" skal være et positivt heltal med eller uden en gyldig måleenhed (%2).',
    invalidCssLength:
  ...
  notification: { closed: "Notefikation lukket." },
  toolbar: {
  ...
  clipboard: {
    copy: "Kopiér",
    copyError:
      "Din browsers sikkerhedsindstillinger tillader ikke editoren at få automatisk adgang til udklipsholderen. Brug i stedet tastaturet til at kopiere teksten (Ctrl/Cmd+C).",
    cut: "Klip",
    cutError:
      "Din browsers sikkerhedsindstillinger tillader ikke editoren at få automatisk adgang til udklipsholderen. Brug i stedet tastaturet til at klippe teksten (Ctrl/Cmd+X).",
    paste: "Indsæt",
    pasteNotification:
      "Tryk %1 for at sætte ind. Din browser understøtter ikke indsættelse med værktøjslinje knappen eller kontekst menuen.",
  ...
  templates: {
    ...
    selectPromptMsg:
      "Vælg den skabelon, som skal åbnes i editoren (nuværende indhold vil blive overskrevet):",
  ...
  language: { button: "Vælg sprog", remove: "Fjern sprog" },
  link: {
  ...
  pagebreak: { alt: "Sideskift", toolbar: "Indsæt sideskift" },
  pastetext: {
  ...
  preview: { preview: "Vis eksempel" },
  print: { toolbar: "Udskriv" },
  removeformat: { toolbar: "Fjern formatering" },
  save: { toolbar: "Gem" },
  selectall: { toolbar: "Vælg alt" },
  showblocks: { toolbar: "Vis afsnitsmærker" },
  ...
  widget: { move: "Klik og træk for at flytte", label: "%1 widget" },
  uploadwidget: {
