...
CKEDITOR.lang["az"] = {
  ...
  common: {
    ...
    invalidLength:
      '"%1" xanasına, ölçü vahidinin (%2) göstərilməsindən asılı olmayaraq, müsbət ədəd qeyd olunmalıdır.',
    invalidCssLength:
  ...
  blockquote: { toolbar: "Sitat bloku" },
  ...
  colordialog: {
    clear: "Təmizlə",
    highlight: "Ayırmaq",
    options: "Rəng seçimləri",
    selected: "Seçilmiş rəng",
    title: "Rəngi seç",
  },
  templates: {
    button: "Şablon",
  ...
  contextmenu: { options: "Əlavə əməliyyatlar" },
  copyformatting: {
    label: "Formatı köçür",
    notification: {
      ...
      failed:
        "Format etmək mümkün deyil. Siz üslubları köçürmədən onları tədbiq edə bilməzsiniz.",
    },
  },
  div: {
    IdInputLabel: "Id",
  ...
  elementspath: { eleLabel: "Elementin izləri", eleTitle: "%1 element" },
  filetools: {
  ...
  flash: {
    access: "Skript tərəfindən müraciətlərin icazəsi",
    accessAlways: "Həmişə",
    accessNever: "Heç vaxt",
    accessSameDomain: "Eyni domen adından",
    alignAbsBottom: "Aşağıda",
    alignAbsMiddle: "Ortada",
    alignBaseline: "Əsas xətt",
    alignTextTop: "Mətnin yuxarıda",
    bgcolor: "Doldurma rəngi",
    chkFull: "Tam pəncərəyə aça bilər",
    chkLoop: "Dövrələmə",
    chkMenu: "Flash menyunu göstər",
    chkPlay: "Birbaşa oynat",
    flashvars: "Flash üçün dəyişənlər",
    hSpace: "Üfüqi boşluq",
    properties: "Flash xüsusiyyətləri",
    propertiesTab: "Xüsusiyyətlər",
    quality: "Keyfiyyət",
    qualityAutoHigh: "Avtomatik yüksək",
    qualityAutoLow: "Avtomatik aşağı",
    qualityBest: "Mükəmməl",
    qualityHigh: "Yüksək",
    qualityLow: "Aşağı",
    qualityMedium: "Orta",
    scale: "Dəyişkən",
    scaleAll: "Hamısını göstər",
    scaleFit: "Həqiqi ölçülər",
    scaleNoBorder: "Sərhədsiz",
    title: "Flash xüsusiyyətləri",
    vSpace: "Şaquli boşluq",
    validateHSpace: "Üfüqi boşluq rəqəm olmalıdır.",
    validateSrc: "Link boş ola bilməz",
    validateVSpace: "Şaquli boşluq rəqəm olmalıdır.",
    windowMode: "Pəncərənin rejimi",
    windowModeOpaque: "Görünən",
    windowModeTransparent: "Şəffaf",
    windowModeWindow: "Pəncərə",
  },
  font: {
    fontSize: {
      label: "Şrift ölçüsü",
  ...
  horizontalrule: { toolbar: "Sərhəd xətti yarat" },
  iframe: {
  ...
  indent: { indent: "Sol boşluqu artır", outdent: "Sol boşluqu azalt" },
  smiley: {
    options: "Smayli-nin seçimləri",
    title: "Smayli-ni daxil et",
    toolbar: "Smayli",
  },
  language: { button: "Dilini təyin et", remove: "Dilini sil" },
  link: {
  ...
  liststyle: {
    ...
    none: "Yoxdur",
    notset: "<seçilməmiş>",
    numberedTitle: "Nömrəli siyahının xüsusiyyətləri",
    square: "Dördbucaq",
    start: "Başlanğıc",
    type: "Növ",
  ...
  pastefromword: {
    ...
    error:
      "Daxili səhvə görə əlavə edilən məlumatların təmizlənməsi mümkün deyil",
    title: "Word-dan əlavəetmə",
    toolbar: "Word-dan əlavəetmə",
  },
  preview: { preview: "Öncədən baxılması" },
  print: { toolbar: "Çap et" },
  removeformat: { toolbar: "Formatı sil" },
  save: { toolbar: "Yadda saxla" },
  selectall: { toolbar: "Hamısını seç" },
  showblocks: { toolbar: "Blokları göstər" },
  ...
  undo: { redo: "Təkrar et", undo: "İmtina et" },
  widget: { move: "Tıklayın və aparın", label: "%1 vidjet" },
  uploadwidget: {
