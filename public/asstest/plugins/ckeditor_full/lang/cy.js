...
CKEDITOR.lang["cy"] = {
  ...
  forms: {
    ...
    hidden: { title: "Priodweddau Maes Cudd", name: "Enw", value: "Gwerth" },
    select: {
  ...
  language: { button: "Gosod iaith", remove: "Tynnu iaith" },
  link: {
  ...
  newpage: { toolbar: "Tudalen Newydd" },
  pagebreak: {
    alt: "Toriad Tudalen",
  ...
  print: { toolbar: "Argraffu" },
  removeformat: { toolbar: "Tynnu Fformat" },
  save: { toolbar: "Cadw" },
  selectall: { toolbar: "Dewis Popeth" },
  showblocks: { toolbar: "Dangos Blociau" },
