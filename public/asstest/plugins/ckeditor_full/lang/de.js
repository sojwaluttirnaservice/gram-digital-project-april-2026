...
CKEDITOR.lang["de"] = {
  ...
  common: {
    ...
    invalidLength:
      'Der für das Feld "%1" angegebene Wert muss eine positive Zahl mit oder ohne gültige Maßeinheit (%2) sein. ',
    invalidCssLength:
  ...
  notification: { closed: "Benachrichtigung geschlossen." },
  toolbar: {
  ...
  clipboard: {
    ...
    paste: "Einfügen",
    pasteNotification:
      "Drücken Sie %1 zum Einfügen. Ihr Browser unterstützt nicht das Einfügen über dem Knopf in der Toolbar oder dem Kontextmenü.",
  ...
  filetools: {
    ...
    networkError:
      "Während des Hochladens der Datei ist ein Netzwerkfehler aufgetreten.",
    httpError404:
      "Während des Hochladens der Datei ist ein HTTP-Fehler aufgetreten (404: Datei nicht gefunden).",
    httpError403:
      "Während des Hochladens der Datei ist ein HTTP-Fehler aufgetreten (403: Verboten).",
    httpError:
      "Während des Hochladens der Datei ist ein HTTP-Fehler aufgetreten (Fehlerstatus: %1).",
  ...
  language: { button: "Sprache festlegen", remove: "Sprache entfernen" },
  link: {
  ...
  print: { toolbar: "Drucken" },
  removeformat: { toolbar: "Formatierung entfernen" },
  save: { toolbar: "Speichern" },
  selectall: { toolbar: "Alles auswählen" },
  showblocks: { toolbar: "Blöcke anzeigen" },
