...
CKEDITOR.lang["bg"] = {
  ...
  common: {
    ...
    invalidLength:
      'Стойността на полето "%1" трябва да е положително число с или без валидна мерна единица (%2).',
    invalidCssLength:
      'Стойността на полето "%1" трябва да е положително число с или без валидна CSS мерна единица (px, %, in, cm, mm, em, ex, pt, или pc).',
    invalidHtmlLength:
      'Стойността на полето "%1" трябва да е положително число с или без валидна HTML мерна единица (px или %).',
    invalidInlineStyle:
  ...
  notification: { closed: "Известието е затворено." },
  toolbar: {
  ...
  clipboard: {
    copy: "Копирай",
    copyError:
      "Настройките за сигурност на вашия бразуър не разрешават на редактора да изпълни действията по копиране. За целта използвайте клавиатурата (Ctrl+C).",
    cut: "Отрежи",
    cutError:
      "Настройките за сигурност на вашия браузър не позволяват на редактора автоматично да изъплни действията за отрязване. За целта използвайте клавиатурата (Ctrl+X).",
    paste: "Вмъкни",
    pasteNotification:
      "Натиснете %1 за да вмъкнете. Вашият браузър не поддържа поставяне с бутон от лентата с инструменти или от контекстното меню.",
  ...
  filetools: {
    loadError: "Възникна грешка при четене на файла.",
    networkError: "Възникна мрежова грешка при качването на файла.",
    httpError404:
      "Възникна HTTP грешка при качване на файла (404: Файлът не е намерен).",
    httpError403: "Възникна HTTP грешка при качване на файла (403: Забранено).",
    httpError:
      "Възникна HTTP грешка при качване на файла (статус на грешката: %1).",
    noUrlError: "URL адресът за качване не е дефиниран.",
  ...
  flash: {
    ...
    vSpace: "Y отстъп",
    validateHSpace: "X отстъп трябва да е число.",
    validateSrc: "URL адресът не трябва да е празен.",
    validateVSpace: "Y отстъп трябва да е число.",
    windowMode: "Режим на прозореца",
    windowModeOpaque: "Плътно",
  ...
  image: {
    ...
    button2Img:
      "Искате ли да превърнете избрания бутон за изображение в просто изображение?",
    hSpace: "Хоризонтален отстъп",
    img2Button:
      "Искате ли да превърнете избраното изображение в бутон за изображение?",
    infoTab: "Изображение",
    linkTab: "Връзка",
  ...
  language: { button: "Задай език", remove: "Премахни език" },
  link: {
  ...
  pastetext: {
    ...
    pasteNotification:
      "Натиснете %1 за да поставите. Вашият браузър не поддържа поставяне с бутон от лентата с инструменти или контекстното меню.",
    title: "Вмъкни като чист текст",
  },
  pastefromword: {
    confirmCleanup:
      "Текстът, който искате да поставите, изглежда е копиран от Word. Искате ли да се почисти преди поставянето?",
    error:
      "Вмъкваните данни не могат да бъдат почистени поради вътрешна грешка",
  ...
  save: { toolbar: "Запис" },
  selectall: { toolbar: "Избери всичко" },
  showblocks: { toolbar: "Показва блокове" },
  ...
  table: {
    ...
    invalidCellPadding:
      "Отстоянието на клетките трябва да е положително число.",
  ...
  undo: { redo: "Пренаправи", undo: "Отмени" },
  widget: { move: "Кликни и влачи, за да преместиш", label: "%1 приставка" },
  uploadwidget: {
    ...
    uploadMany:
      "Качване на файлове, {current} от {max} качени ({percentage}%)...",
  },
  wsc: {
    btnIgnore: "Игнорирай",
