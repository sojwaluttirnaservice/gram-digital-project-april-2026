...
CKEDITOR.lang["fa"] = {
  ...
  bidi: { ltr: "جهت متن از چپ به راست", rtl: "جهت متن از راست به چپ" },
  blockquote: { toolbar: "بلوک نقل قول" },
  notification: { closed: "آگاه‌سازی بسته شد" },
  toolbar: {
  ...
  clipboard: {
    ...
    paste: "چسباندن",
    pasteNotification:
      "1% را فشاردهید تا قرار داده شود. مرورگر شما از قراردهی با دکمه نوارابزار یا گزینه منوی زمینه پشتیبانی نمیکند",
  ...
  templates: {
    ...
    selectPromptMsg:
      "لطفاً الگوی مورد نظر را برای بازکردن در ویرایشگر انتخاب کنید",
  ...
  language: { button: "تعیین زبان", remove: "حذف زبان" },
  link: {
  ...
  newpage: { toolbar: "برگهٴ تازه" },
  pagebreak: { alt: "شکستن صفحه", toolbar: "گنجاندن شکستگی پایان برگه" },
  pastetext: {
  ...
  preview: { preview: "پیشنمایش" },
  print: { toolbar: "چاپ" },
  removeformat: { toolbar: "برداشتن فرمت" },
  save: { toolbar: "ذخیره" },
  selectall: { toolbar: "گزینش همه" },
  showblocks: { toolbar: "نمایش بلوک‌ها" },
  ...
  widget: { move: "کلیک و کشیدن برای جابجایی", label: "ابزارک %1" },
  uploadwidget: {
    ...
    uploadMany:
      "بارگذاری فایل​ها, {current} از {max} انجام شده ({percentage}%)...",
  },
  wsc: {
    btnIgnore: "چشمپوشی",
