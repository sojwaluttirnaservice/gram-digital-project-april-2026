        ...
        elements: {
          ...
          font: function (d) {
            if (d.getHtml().match(/^\s*$/))
              return new CKEDITOR.htmlParser.text(" ").insertAfter(d), !1;
            a &&
          ...
          span: function (b) {
            b.filterChildren(c);
            b.attributes.style = k.normalizedStyles(b, a);
            if (
              !b.attributes.style ||
              b.attributes.style.match(/^mso\-bookmark:OLE_LINK\d+$/) ||
              b.getHtml().match(/^(\s|&nbsp;)+$/)
            )
              return t.elements.replaceWithChildren(b), !1;
            b.attributes.style.match(/FONT-FAMILY:\s*Symbol/i) &&
              b.forEach(
                function (a) {
