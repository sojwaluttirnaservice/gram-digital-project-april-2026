(function () {
  ...
  function q(a, m) {
    ...
    var q = (function () {
        var g = CKEDITOR.tools.extend({}, CKEDITOR.dtd.$blockLimit);
        a.config.div_wrapTable && (delete g.td, delete g.th);
        return g;
      })(),
      u = CKEDITOR.dtd.div,
      n = {},
    ...
    return {
      ...
      onShow: function () {
        "editdiv" == m && this.setupContent(this.getModel(a));
      },
      onOk: function () {
      ...
      onHide: function () {
        this.getMode(a) === CKEDITOR.dialog.EDITING_MODE &&
          this.getModel(a).removeCustomData("elementStyle");
      },
    };
  }
