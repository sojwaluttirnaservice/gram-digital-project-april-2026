  ...
  legend: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          legend:
            "Apasă ${elementsPathFocus} pentru navigare pe elementele barei. Mergi la următorul buton cu TAB sau SĂGEATĂ JOS. Treci la butonul anterior din listă cu SHIFT+TAB sau SĂGEATĂ SUS. Apasă SPAȚIU sau ENTER pentru a selecta butonul în editor.",
        },
      ],
    },
    {
      name: "Comenzi",
      items: [
        { name: "Revino anterior (Undo)", legend: "Apasă ${undo}" },
        { name: "Comanda precedentă", legend: "Apasă ${redo}" },
        { name: "Îngroșat (Bold)", legend: "Apasă ${bold}" },
        { name: "Înclinat (Italic)", legend: "Apasă ${italic}" },
        { name: "Subliniere (Underline)", legend: "Apasă ${underline}" },
        { name: "Legatură (Link)", legend: "Apasă ${link}" },
        {
        ...
        },
        {
          ...
          legend:
            "Apasă ${accessPreviousSpace} pentru a accesa cel mai apropiat spațiu focus indisponibil înaintea cursorului, de exemplu: 2 elemente adiacente HR. Repetă combinația de taste pentru a accesa spațiile îndepărtate de focus.",
        },
        {
          name: "Accesare spațiu focus următor",
          legend:
            "Apasă ${accessNextSpace} pentru a accesa cel mai apropiat spațiu focus indisponibil după cursor, de exemplu: 2 elemente adiacente HR. Repetă combinația de taste pentru a accesa spațiile îndepărtate de focus.",
        },
        { name: "Ajutor Accesibilitate", legend: "Apasă ${a11yHelp}" },
        {
