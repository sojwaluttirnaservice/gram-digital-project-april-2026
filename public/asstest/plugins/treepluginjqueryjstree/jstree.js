    ...
    init: function (el, options) {
      ...
      this.element.html(
        "<" +
          ...
          "li id='j" +
          this._id +
          "_loading' class='jstree-initial-node jstree-loading jstree-leaf jstree-last' role='treeitem'><i class='jstree-icon jstree-ocl'></i><" +
    ...
    get_node: function (obj, as_dom) {
      ...
      try {
        if (this._model.data[obj]) {
          ...
          (dom = this.element.find(obj)).length &&
          this._model.data[dom.closest(".jstree-node").attr("id")]
        ) {
          obj = this._model.data[dom.closest(".jstree-node").attr("id")];
        } else if (
    ...
    check: function (chk, obj, par, pos, more) {
      ...
      if (chk === "move_node" || chk === "copy_node") {
        if (
          (!more || !more.is_multi) &&
          chk === "move_node" &&
          $.inArray(obj.id, par.children) === pos
        ) {
          this._data.core.last_error = {
            error: "check",
            plugin: "core",
            ...
            if (
              ...
              $.each(o, function (j, v) {
                ...
                if (ok) {
                  ...
                  marker
                    .removeClass("jstree-above jstree-inside jstree-below")
                    .addClass(c);
                  data.helper
                    .find(".jstree-icon")
                    .first()
