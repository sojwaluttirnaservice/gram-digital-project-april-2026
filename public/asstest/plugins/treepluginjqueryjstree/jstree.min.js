  ...
  if (!a.jstree) {
          ...
          (this._model = {
            ...
            this.element.html(
              "<ul class='jstree-container-ul jstree-children' role='group'><li id='j" +
                this._id +
                "_loading' class='jstree-initial-node jstree-loading jstree-leaf jstree-last' role='treeitem'><i class='jstree-icon jstree-ocl'></i><a class='jstree-anchor' href='#'><i class='jstree-icon jstree-themeicon-hidden'></i>" +
            ...
            var f = null,
              ...
              i = function (a, b) {
                ...
                var c = a.dat,
                  ...
                  s = function (a, c, d) {
                    ...
                    for (
                      ...
                      (j = s(l[m.children[f]], m.id, d)),
                        ...
                        m.children_d.push(j),
                        k.children_d.length &&
                          (m.children_d = m.children_d.concat(k.children_d));
                    return (
                      delete a.data,
                      delete a.children,
                      (l[m.id].original = a),
                  ...
                  t = function (a, c, d) {
                    ...
                    if (a && a.children && a.children.length) {
                      for (f = 0, h = a.children.length; h > f; f++)
                ...
                if (c.length && c[0].id !== b && c[0].parent !== b) {
                  for (p = 0, q = c.length; q > p; p++)
                    c[p].children || (c[p].children = []),
                      c[p].state || (c[p].state = {}),
                      (l[c[p].id.toString()] = c[p]);
                  for (p = 0, q = c.length; q > p; p++)
                    l[c[p].parent.toString()]
                      ? (l[c[p].parent.toString()].children.push(
                          c[p].id.toString(),
                        ),
                        m.children_d.push(c[p].id.toString()))
                      : "undefined" != typeof h &&
                        ((h._data.core.last_error = {
                          error: "parse",
                          plugin: "core",
                          id: "core_07",
                  ...
                  for (p = 0, q = m.children.length; q > p; p++)
                    (o = s(l[m.children[p]], d, m.parents.concat())),
                      f.push(o),
                      l[o].children_d.length && (f = f.concat(l[o].children_d));
                  for (p = 0, q = m.parents.length; q > p; p++)
                    l[m.parents[p]].children_d =
                      l[m.parents[p]].children_d.concat(f);
                  r = { cnt: k, mod: l, sel: n, par: d, dpc: f, add: g };
                } else {
                  for (p = 0, q = c.length; q > p; p++)
                    (o = t(c[p], d, m.parents.concat())),
                      o &&
                        (e.push(o),
                        f.push(o),
                        l[o].children_d.length &&
                          (f = f.concat(l[o].children_d)));
                  for (
                    m.children = e,
                      m.children_d = f,
                      p = 0,
                ...
                if (null !== this.element) {
                  ...
                  if (((this._model.data = b.mod), c)) {
                    ...
                    if (
                      ((f = this._model.data),
                      k.length !== l.length ||
                        a.vakata.array_unique(k.concat(l)).length !== k.length)
                    ) {
                      for (e = 0, g = k.length; g > e; e++)
                        -1 === a.inArray(k[e], i) &&
                          -1 === a.inArray(k[e], l) &&
                          (f[k[e]].state.selected = !1);
                      for (e = 0, g = l.length; g > e; e++)
                        -1 === a.inArray(l[e], k) &&
                          (f[l[e]].state.selected = !0);
                    }
                  }
                  b.add.length &&
              ...
              try {
                null === this._wrk &&
                  (this._wrk = window.URL.createObjectURL(
                    new window.Blob(["self.onmessage = " + i.toString()], {
                ...
                .on(
                  ...
                  a.proxy(function (b, c) {
                    var d = this,
                      ...
                      h,
                      i,
                      j = this.settings.checkbox.cascade,
                    ...
                    if (-1 !== j.indexOf("up") && -1 === l.indexOf(e.id)) {
                      for (g = 0, h = e.parents.length; h > g; g++)
                        (i = this._model.data[e.parents[g]]),
                          (i.state[k ? "selected" : "checked"] = !1),
                          i &&
                            i.original &&
                            i.original.state &&
                            i.original.state.undetermined &&
                            (i.original.state.undetermined = !1),
                          ...
                          i &&
                            ...
                            i
                              ...
                              .children(".jstree-anchor")
                              .removeClass(
                                k ? "jstree-clicked" : "jstree-checked",
                              );
                      l = a.vakata.array_filter(l, function (a) {
          ...
          show: function (d, e, f) {
            ...
            d &&
              ...
              c.items.length &&
                ...
                b &&
                  ((j -= h.outerWidth() - a(d).outerWidth()),
                  j < a(window).scrollLeft() + 20 &&
                    (j = a(window).scrollLeft() + 20)),
                j + l + 20 > n && (j = n - (l + 20)),
                k + m + 20 > o && (k = o - (m + 20)),
                c.element
    ...
    (a.jstree.plugins.dnd = function (b, c) {
      ...
      a(function () {
        ...
        a(i)
          .on("dragover.vakata.jstree", function (b) {
            n &&
              a.vakata.dnd._trigger("move", b, {
                helper: a(),
                element: n,
        ...
        a.vakata.dnd = {
          ...
          start: function (b, d, e) {
            ...
            return (
              ...
              e !== !1 &&
                (c.helper = a("<div id='vakata-dnd'></div>")
                  .html(e)
                  .css({
                    display: "block",
                    margin: "0",
          ...
          (this._load_nodes = function (b, d, e, f) {
            ...
            if (!e) {
              for (j = 0, k = b.length; k > j; j++)
                (!i[b[j]] ||
                  (!i[b[j]].state.loaded && !i[b[j]].state.failed) ||
                  f) &&
                  (h.push(b[j]),
                  (l = this.get_node(b[j], !0)),
                  l &&
                    l.length &&
                    l.addClass("jstree-loading").attr("aria-busy", !0));
