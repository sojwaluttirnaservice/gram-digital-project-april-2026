(function (p) {
  ...
  p.defineMode("javascript", function (oa, t) {
    ...
    function w(a, c) {
      ...
      if (/\d/.test(e))
        return (
          a.match(/^\d*(?:\.\d*)?(?:[eE][+\-]?\d+)?/), q("number", "number")
        );
      if ("/" == e) {
    ...
    function x(a) {
      function c(c) {
        for (; c; c = c.next) if (c.name == a) return !0;
        return !1;
      }
      var b = f.state;
      b.context
    ...
    function r(a, c) {
      return "var" == a
        ...
        ? b(l("stat"), sa)
        : "switch" == a
        ? b(l("form"), n, l("}", "switch"), m("{"), U, k, k)
        : "case" == a
        ? b(n, m(":"))
        : "default" == a
        ? b(m(":"))
        : "catch" == a
        ? b(l("form"), y, m("("), V, m(")"), r, k, z)
        : "module" == a
        ? b(l("form"), y, ta, z, k)
        : "class" == a
        ? b(l("form"), ua, k)
    ...
    function Aa(a) {
      if ("variable" == a) return (f.marked = "property"), b();
    }
    function za(a, c) {
    ...
    function Da(a) {
      if ("variable" == a) return (f.marked = "variable-3"), b();
    }
    function T() {
      return g(A, ja, Y, Ea);
    }
    function A(a, c) {
      if ("variable" == a) return x(c), b();
      if ("[" == a) return G(A, "]");
      if ("{" == a) return G(Fa, "}");
    }
    function Fa(a, c) {
    ...
    function v(a, c) {
      if ("*" == c) return (f.marked = "keyword"), b(v);
      if ("variable" == a) return x(c), b(v);
      if ("(" == a) return b(y, l(")"), F(V, ")"), k, r, z);
    }
    function V(a) {
      return "spread" == a ? b(V) : g(A, ja);
    }
    function ua(a, c) {
      if ("variable" == a) return x(c), b(ma);
    }
    function ma(a, c) {
      if ("extends" == c) return b(n, ma);
      if ("{" == a) return b(l("}"), B, k);
    }
    function B(a, c) {
      if ("variable" == a || "keyword" == f.style) {
        if ("static" == c) return (f.marked = "keyword"), b(B);
        f.marked = "property";
        return "get" == c || "set" == c ? b(Ia, v, B) : b(v, B);
      }
      if ("*" == c) return (f.marked = "keyword"), b(B);
      if (";" == a) return b(B);
      if ("}" == a) return b();
    }
    function Ia(a) {
      if ("variable" != a) return g();
      f.marked = "property";
      return b();
    }
    function ta(a, c) {
      if ("string" == a) return b(r);
      if ("variable" == a) return x(c), b(Z);
    }
    function va(a, c) {
      return "*" == c
        ? ((f.marked = "keyword"), b(Z, m(";")))
        : "default" == c
        ? ((f.marked = "keyword"), b(n, m(";")))
        : g(r);
    }
    function wa(a) {
    ...
    function Ja(a, c) {
      if ("as" == c) return (f.marked = "keyword"), b(aa);
    }
    function Z(a, c) {
      if ("from" == c) return (f.marked = "keyword"), b(n);
    }
    function ya(a) {
      return "]" == a ? b() : g(u, Ka);
    }
    ...
    function N(a) {
      ...
      if ("if" == a) return b(n, N);
    }
    var C = oa.indentUnit,
      na = t.statementIndent,
      L = t.jsonld,
      D = t.json || L,
      ka = t.typescript,
    ...
    return {
      startState: function (a) {
        a = {
          ...
          lastType: "sof",
          cc: [],
          lexical: new ca((a || 0) - C, 0, "block", !1),
      ...
      indent: function (a, b) {
        ...
        return "vardef" == f
          ? d.indented +
              ("operator" == a.lastType || "," == a.lastType ? d.info + 1 : 0)
          : "form" == f && "{" == e
          ? d.indented
          : "form" == f
          ? d.indented + C
          ...
          ? d.align
            ? d.column + (g ? 0 : 1)
            : d.indented + (g ? 0 : C)
          : d.indented + (/^(?:case|default)\b/.test(b) ? C : 2 * C);
      },
  ...
  p.defineMIME("application/typescript", {
    name: "javascript",
    typescript: !0,
  });
});
