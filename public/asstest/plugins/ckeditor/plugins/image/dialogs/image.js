...
(function () {
  var u = function (d, k) {
    ...
    return {
      ...
      minWidth:
        "moono-lisa" == (CKEDITOR.skinName || d.config.skin) ? 500 : 420,
      minHeight: 360,
      getModel: function (a) {
        var b =
            ...
            "img" === a.getName(),
          c =
            a && "input" === a.getName() && "image" === a.getAttribute("type");
        return b || c ? a : null;
      },
      onShow: function () {
        this.linkEditMode =
      ...
      onHide: function () {
        ...
        this.originalElement &&
          ...
          this.originalElement.removeListener("error", f),
          this.originalElement.removeListener("abort", f),
