...
(function () {
        ...
        on: function (b, d, h, k, g) {
          ...
          if (0 > e.getListenerIndex(d)) {
            ...
            for (var t = e.length - 1; 0 <= t; t--)
              if (e[t].priority <= g)
                return e.splice(t + 1, 0, l), { removeListener: u };
            e.unshift(l);
          }
            ...
            if (e) {
              ...
              if (t.length)
                for (var t = t.slice(0), z, I = 0; I < t.length; I++) {
                  if (e.errorProof)
                    try {
                      z = t[I].call(this, u, l, b, k);
                    } catch (r) {}
                  else z = t[I].call(this, u, l, b, k);
  ...
  (function () {
    ...
    var b = [],
      ...
      e = function (a, b) {
        return "#" == b[0]
          ? String.fromCharCode(parseInt(b.slice(1), 10))
          : u[b];
      };
    ...
    CKEDITOR.tools = {
      arrayCompare: function (a, b) {
        ...
        for (var e = 0; e < a.length; e++) if (a[e] != b[e]) return !1;
        return !0;
      },
      getIndex: function (a, b) {
        for (var e = 0; e < a.length; ++e) if (b(a[e])) return e;
        return -1;
      },
      clone: function (a) {
        var b;
      ...
      extend: function (a) {
        var b = arguments.length,
          e,
          c;
        "boolean" == typeof (e = arguments[b - 1])
          ? b--
          : "boolean" == typeof (e = arguments[b - 2]) &&
            ((c = arguments[b - 1]), (b -= 2));
        for (var g = 1; g < b; g++) {
          var m = arguments[g] || {};
          CKEDITOR.tools.array.forEach(
            ...
            function (b) {
              if (!0 === e || null == a[b]) if (!c || b in c) a[b] = m[b];
            },
          );
        }
        return a;
      ...
      buildStyleHtml: function (a) {
        ...
        for (var b, e = [], c = 0; c < a.length; c++)
          if ((b = a[c]))
            /@import|[{}]/.test(b)
              ? e.push("\x3cstyle\x3e" + b + "\x3c/style\x3e")
              : e.push(
      ...
      transformPlainTextToHtml: function (a, b) {
        ...
        e ||
          (c = c.replace(
            new RegExp("\x3cbr\x3e(?\x3d\x3c/" + g + "\x3e)"),
            function (a) {
      ...
      normalizeCssText: function (a, b) {
        var e = [],
          c,
          g = CKEDITOR.tools.parseCssText(a, !0, b);
      ...
      parseCssText: function (a, b, e) {
        ...
        a.replace(/&quot;/g, '"').replace(
          ...
          function (a, e, x) {
            b &&
              ((e = e.toLowerCase()),
              "font-family" == e && (x = x.replace(/\s*,\s*/g, ",")),
      ...
      objectCompare: function (a, b, e) {
        ...
        if (!a && !b) return !0;
        if (!a || !b) return !1;
        for (c in a) if (a[c] != b[c]) return !1;
        if (!e) for (c in b) if (a[c] != b[c]) return !1;
        return !0;
      },
      ...
      enableHtml5Elements: function (a, b) {
        for (
          ...
          (g = a.createElement(e[c])), b && a.appendChild(g);
      },
      checkIfAnyArrayItemMatches: function (a, b) {
        for (var e = 0, c = a.length; e < c; ++e) if (a[e].match(b)) return !0;
        return !1;
      },
      checkIfAnyObjectPropertyMatches: function (a, b) {
        for (var e in a) if (e.match(b)) return !0;
        return !1;
      },
      ...
      keystrokeToArray: function (a, b) {
        var e = b & 16711680,
          ...
          d = [];
        e & CKEDITOR.CTRL &&
          (m.push(g ? "⌘" : a[17]), d.push(g ? a[224] : a[17]));
        e & CKEDITOR.ALT && (m.push(g ? "⌥" : a[18]), d.push(a[18]));
        e & CKEDITOR.SHIFT && (m.push(g ? "⇧" : a[16]), d.push(a[16]));
        c &&
          (a[c]
            ? (m.push(a[c]), d.push(a[c]))
            : (m.push(String.fromCharCode(c)), d.push(String.fromCharCode(c))));
        return { display: m, aria: d };
      },
      ...
      getCookie: function (a) {
        ...
        for (var b = document.cookie.split(";"), e, c, g = 0; g < b.length; g++)
          if (
            ((e = b[g].split("\x3d")),
            (c = decodeURIComponent(CKEDITOR.tools.trim(e[0]).toLowerCase())),
            c === a)
          )
      ...
      getCsrfToken: function () {
        ...
        if (!a || 40 != a.length) {
          ...
          for (e = 0; e < a.length; e++)
            var c = "abcdefghijklmnopqrstuvwxyz0123456789".charAt(a[e] % 36),
              b = b + (0.5 < Math.random() ? c.toUpperCase() : c);
          a = b;
      ...
      style: {
        parse: {
          ...
          background: function (a) {
            ...
            e.length &&
              ((b.color = e[0]),
              CKEDITOR.tools.array.forEach(e, function (b) {
                a = a.replace(b, "");
              }));
      ...
      object: {
        ...
        findKey: function (a, b) {
          ...
          for (var e in a) if (a[e] === b) return e;
          return null;
        },
        merge: function (a, b) {
          ...
          e.array.forEach(e.object.keys(g), function (a) {
            c[a] =
              "object" === typeof g[a] && "object" === typeof c[a]
                ? e.object.merge(c[a], g[a])
                : g[a];
          });
          return c;
        },
    ...
    CKEDITOR.tools.style.border = CKEDITOR.tools.createClass({
      ...
      statics: {
        ...
        splitCssValues: function (a, b) {
          b = b || {};
          var e = CKEDITOR.tools.array.reduce(
            ["width", "style", "color"],
            function (e, c) {
  ...
  CKEDITOR.dtd = (function () {
    var a = CKEDITOR.tools.extend,
      d = function (a, b) {
        for (
          var c = CKEDITOR.tools.clone(a), g = 1;
          g < arguments.length;
          g++
        ) {
          b = arguments[g];
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
      ...
      getAttributes: function (a) {
        ...
        for (e = 0; e < c.length; e++)
          -1 === CKEDITOR.tools.indexOf(a, c[e].name) &&
            (b[c[e].name] = c[e].value);
        return b;
      },
        ...
        for (var a = this.getChildren(), b = 0, c = a.count(); b < c; b++) {
          ...
          if (e.type != CKEDITOR.NODE_ELEMENT || !e.data("cke-bookmark"))
            if (
              ...
              (e.type == CKEDITOR.NODE_TEXT && CKEDITOR.tools.trim(e.getText()))
            )
              return !1;
        }
        return !0;
      ...
      moveChildren: function (a, b) {
        ...
        if (c != a) {
          ...
          else for (; (e = c.firstChild); ) a.appendChild(c.removeChild(e));
        }
      },
      ...
      unselectable: function () {
        ...
        if (CKEDITOR.env.ie) {
          ...
          for (
            var a, b = this.getElementsByTag("*"), c = 0, e = b.count();
            c < e;
            c++
          )
      ...
      getDocumentPosition: function (a) {
        ...
        if (
          ...
          var f = this.$.getBoundingClientRect(),
            ...
            k = !0;
          CKEDITOR.env.ie &&
            ((k = e.getDocumentElement().contains(this)),
            (e = e.getBody().contains(this)),
            (k = (t && e) || (!t && k)));
          k &&
            (CKEDITOR.env.webkit ||
            (CKEDITOR.env.ie && 12 <= CKEDITOR.env.version)
              ? ((b = d.$.scrollLeft || h.scrollLeft),
                (c = d.$.scrollTop || h.scrollTop))
              : ((c = t ? d.$ : h), (b = c.scrollLeft), (c = c.scrollTop)),
            (b = f.left + b - m),
            (c = f.top + c - r));
        } else
          for (
            r = this, m = null;
            r && "body" != r.getName() && "html" != r.getName();

          ) {
            b += r.$.offsetLeft - r.$.scrollLeft;
            c += r.$.offsetTop - r.$.scrollTop;
            r.equals(this) ||
              ((b += r.$.clientLeft || 0), (c += r.$.clientTop || 0));
            for (; m && !m.equals(r); )
      ...
      scrollIntoParent: function (a, b, c) {
        ...
        function r(a, b) {
          ...
          e = a.getWindow();
          e.equals(b) ||
            ((e = r(CKEDITOR.dom.element.get(e.$.frameElement), b)),
            (c.x += e.x),
            (c.y += e.y));
          return c;
        }
        ...
        a instanceof CKEDITOR.dom.window &&
          (a = k ? t.getBody() : t.getDocumentElement());
        CKEDITOR.env.webkit &&
          (t = this.getEditor(!1)) &&
          (t._.previousScrollTop = null);
        t = a.getWindow();
        d = r(this, t);
        var y = r(a, t),
          J = this.$.offsetHeight;
        ...
        var E = a.$.clientHeight,
          p = a.$.clientWidth;
        t = d.x - m(this, "left") - y.x || 0;
        f = d.y - m(this, "top") - y.y || 0;
        e = d.x + e + m(this, "right") - (y.x + p) || 0;
        d = d.y + J + m(this, "bottom") - (y.y + E) || 0;
      ...
      copyAttributes: function (a, b) {
        ...
        for (var e = 0; e < c.length; e++) {
          var d = c[e],
            ...
            f;
          if (!(t in b))
            if ("checked" == t && (f = this.getAttribute(t)))
              a.setAttribute(t, f);
            else if (!CKEDITOR.env.ie || this.hasAttribute(t))
      ...
      getEditor: function (a) {
        ...
        for (c in b)
          if (
            ((e = b[c]),
            (e.element.equals(this) &&
              e.elementMode != CKEDITOR.ELEMENT_MODE_APPENDTO) ||
              (!a &&
                (d = e.editable()) &&
  ...
  (function () {
    function a(a, b) {
      ...
      var f = c.startOffset,
        ...
        g = this.guard,
        p = this.type,
        D = a ? "getPreviousSourceNode" : "getNextSourceNode";
      if (!a && !this._.guardLTR) {
        var G = e.type == CKEDITOR.NODE_ELEMENT ? e : e.getParent(),
          B = e.type == CKEDITOR.NODE_ELEMENT ? e.getChild(x) : e.getNext();
            ...
            ? e.type == CKEDITOR.NODE_ELEMENT &&
              (e =
                0 < x
                  ...
                  : !1 === h(e, !0)
                  ? null
                  : e.getPreviousSourceNode(!0, p, h))
            : ((e = d),
              e.type == CKEDITOR.NODE_ELEMENT &&
                ((e = e.getChild(f)) ||
                  (e =
                    !1 === h(d, !0) ? null : d.getNextSourceNode(!0, p, h)))),
          e && !1 === h(e) && (e = null));
      for (; e && !this._.end; ) {
        this.current = e;
    ...
    CKEDITOR.dom.walker.bogus = function (a) {
      ...
      return function (c) {
        var e = CKEDITOR.env.needsBrFiller
          ? c.is && c.is("br")
          ...
          : b.type == CKEDITOR.NODE_TEXT ||
            (b.type == CKEDITOR.NODE_ELEMENT &&
              (b.is(CKEDITOR.dtd.$inline) ||
                ...
                (!CKEDITOR.env.needsBrFiller && b.is(x) && e(b))))
          ? !0
          : !1;
        return !!(a ^ b);
      };
  ...
  (function () {
    ...
    function d(a, b, c, d, f) {
      function h(a, b, c, e) {
        ...
        if (e && k) return A;
        l || e
          ? b.append(a.clone(!0, f), c)
          : (a.remove(), u && b.append(a, c));
        return A;
      }
      function m() {
        var a,
      ...
      function g() {
        ...
        b < H - 1 || b < F - 1 || c
          ? (c
              ...
              : F == b + 1 && q
              ? a.moveToPosition(n[b], CKEDITOR.POSITION_BEFORE_END)
              : a.moveToPosition(n[b + 1], CKEDITOR.POSITION_BEFORE_START),
            d &&
              (b = S[b + 1]) &&
              b.type == CKEDITOR.NODE_ELEMENT &&
      ...
      if (
        ...
        (p.equals(D) ||
          (p.type === CKEDITOR.NODE_ELEMENT && p.getFirst().equals(D)))
      )
        c.append(a.document.createText(D.substring(G, B)));
      else {
        D.type == CKEDITOR.NODE_TEXT
          ? l
            ? (Q = !0)
        ...
        for (
          ...
          L = ba.getNext();
          for (
            T != H || (ba.equals(n[T]) && H < F)
              ? b && (A = K.append(ba.clone(0, f)))
              : N
              ? h(ba, K, !1, C)
              : v && K.append(a.document.createText(ba.substring(G)));
            L;
        ...
        K = c;
        for (T = O; T <= F; T++)
          if (((c = n[T]), (L = c.getPrevious()), c.equals(S[T])))
            b && (K = K.getChild(0));
          else {
            T != F || (c.equals(S[T]) && F < H)
              ? b && (A = K.append(c.clone(0, f)))
              : q
              ? h(c, K, !1, w)
              : Q && K.append(a.document.createText(c.substring(0, B)));
            if (T > da) for (; L; ) L = h(L, K, !0);
            K = A;
          }
        l || g();
      }
      ...
      return function (f) {
        return c(f) || b(f)
          ...
          : (f.type == CKEDITOR.NODE_TEXT &&
            ...
            (f.type == CKEDITOR.NODE_ELEMENT && !f.is(h))
          ? !1
          : !0;
      };
    }
    ...
    CKEDITOR.dom.range.prototype = {
      ...
      createBookmark: function (a) {
        ...
        a &&
          ...
          h.setAttribute("id", g + (f ? "C" : "S")));
        f ||
          ((m = h.clone()),
          m.setHtml("\x26nbsp;"),
          a && m.setAttribute("id", g + "E"),
          (k = this.clone()),
          b(d) &&
        ...
        k.insertNode(h);
        m
          ? (this.setStartAfter(h), this.setEndBefore(m))
      ...
      createBookmark2: (function () {
        function a(b) {
          ...
          var f = d;
          m =
            m.type != CKEDITOR.NODE_ELEMENT || 0 === f || f == m.getChildCount()
              ? 0
              : m.getChild(f - 1).type == CKEDITOR.NODE_TEXT &&
                m.getChild(f).type == CKEDITOR.NODE_TEXT;
          ...
          if (e.type == CKEDITOR.NODE_TEXT) {
            m = e;
            for (f = 0; (m = m.getPrevious()) && m.type == CKEDITOR.NODE_TEXT; )
              f += m
                .getText()
                .replace(
            ...
            e.isEmpty()
              ? ((f = e.getPrevious(c)),
                m
                  ? ((d = m), (e = f ? f.getNext() : e.getParent().getFirst()))
                  : ((e = e.getParent()), (d = f ? f.getIndex(!0) + 1 : 0)))
              : (d += m);
          }
          b.container = e;
          b.offset = d;
        ...
        return function (c) {
          ...
          c && (a(f), b(f, this.root), d || (a(m), b(m, this.root)));
          return {
      ...
      enlarge: function (a, b) {
        ...
        switch (a) {
          ...
          case CKEDITOR.ENLARGE_ELEMENT:
            ...
            B.type == CKEDITOR.NODE_TEXT
              ? (q &&
                  ((B = !CKEDITOR.tools.trim(B.substring(0, q)).length && B),
                  (G = !!B)),
                B && ((p = B.getPrevious()) || (l = B.getParent())))
              : (q && (p = B.getChild(q - 1) || B.getLast()), p || (l = B));
            for (l = c(l); l || p; ) {
              if (l && !p) {
                !D && l.equals(m) && (D = !0);
                if (f ? l.isBlockBoundary() : !g.contains(l)) break;
                (G && "inline" == l.getComputedStyle("display")) ||
                  ((G = !1), D ? (k = l) : this.setStartBefore(l));
                p = l.getPrevious();
              }
              for (; p; )
                if (((B = !1), p.type == CKEDITOR.NODE_COMMENT))
                  p = p.getPrevious();
                else {
                  if (p.type == CKEDITOR.NODE_TEXT)
                    ...
                    (p.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) ||
                      (b && p.is("br"))) &&
                    !p.data("cke-bookmark")
                  )
                    if (G && CKEDITOR.dtd.$removeEmpty[p.getName()]) {
                      N = p.getText();
                      if (d.test(N)) p = null;
                      else
                        for (
                          var q = p.$.getElementsByTagName("*"), C = 0, w;
                          (w = q[C++]);

                        )
                          if (
                            !CKEDITOR.dtd.$removeEmpty[w.nodeName.toLowerCase()]
                          ) {
                            p = null;
                            break;
                          }
            ...
            D = G = !1;
            B.type == CKEDITOR.NODE_TEXT
              ? CKEDITOR.tools.trim(B.substring(q)).length
                ? (G = !0)
                : ((G = !B.getLength()),
                  q == B.getLength()
            ...
            for (; l || p; ) {
              if (l && !p) {
                ...
                if (f ? l.isBlockBoundary() : !g.contains(l)) break;
                (G && "inline" == l.getComputedStyle("display")) ||
                  ((G = !1), D ? (u = l) : l && this.setEndAfter(l));
                p = l.getNext();
              }
              for (; p; ) {
                B = !1;
          ...
          case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
            ...
            var v,
              Q,
              S = CKEDITOR.dom.walker.blockBoundary(
            ...
            this.setStartAt(
              v,
              !v.is("br") &&
                ((!l && this.checkStartOfBlock()) || (l && v.contains(l)))
            ...
            l = new CKEDITOR.dom.walker(l);
            l.guard = a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? f : O;
            v = n = Q = null;
            l = l.lastForward();
            v = v || g;
            this.setEndAt(
              v,
              (!l && this.checkEndOfBlock()) || (l && v.contains(l))
        ...
        if (!this.collapsed) {
          ...
          h.guard = function (b, c) {
            ...
            if (
              ...
              return !1;
            c || b.type != CKEDITOR.NODE_ELEMENT || (G = b);
            return !0;
          };
          c &&
            (m = h[a == CKEDITOR.SHRINK_ELEMENT ? "lastForward" : "next"]()) &&
            this.setStartAt(
              m,
              b
                ? CKEDITOR.POSITION_AFTER_START
        ...
        return function (b) {
          for (
            var c = this.createBookmark(),
              ...
              f = d.block || d.blockLimit,
              h;
            f && !f.equals(d.root) && !f.getFirst(a(f));
      ...
      moveToClosestEditablePosition: function (a, b) {
        ...
        if (a && !a.is(CKEDITOR.dtd.$block)) d = 1;
          ...
          (f = c[b ? "getNextEditableNode" : "getPreviousEditableNode"]())
        )
          (d = 1),
            ...
            "false" == f.getAttribute("contenteditable")
              ...
              ? (c.setEnd(f, 0), c.collapse())
              : c.moveToPosition(f, m[b ? 1 : 0]);
      ...
      scrollIntoView: function () {
        var a = new CKEDITOR.dom.element.createFromHtml(
          ...
          f = this.clone();
        f.optimize();
        (d = f.startContainer.type == CKEDITOR.NODE_TEXT)
          ...
          c.collapsed
            ? e.startContainer instanceof CKEDITOR.dom.element
              ? ((a = e.checkStartOfBlock()),
                ...
                a
                  ? e.startContainer.append(f, !0)
                  : 0 === e.startOffset
                  ? f.insertBefore(e.startContainer.getFirst())
                  : ((e = e.startContainer
                      .getChildren()
      ...
      _find: function (a, b) {
        ...
        if (c && c.find)
          for (m = c.find(a), h = 0; h < m.count(); h++)
            if (((c = m.getItem(h)), b || !c.isReadOnly()))
              (g =
  ...
  (function () {
    ...
    function b(a, c, f, h) {
      ...
      if (!h) return 0;
      if (
        (g = CKEDITOR.filter.instances[h.element.data("cke-filter")]) &&
        !g.check(c)
      )
        return b(a, c, f, h.remaining);
    ...
    a.prototype = {
      getNextParagraph: function (a) {
        ...
        if (!this._.started) {
          ...
          var m = r.endPath(),
            ...
            y = !r.collapsed && c(r, m.block, 1);
          r.shrink(CKEDITOR.SHRINK_ELEMENT, !0);
          M && r.setStartAt(k.block, CKEDITOR.POSITION_BEFORE_END);
          y && r.setEndAt(m.block, CKEDITOR.POSITION_AFTER_START);
          k =
            r.endContainer.hasAscendant("pre", !0) ||
          ...
          r.collapsed ||
            ((k = new CKEDITOR.dom.walker(r.clone())),
            ...
            (k.evaluator = m),
            (k = k.previous()),
            (this._.lastNode = k.getNextSourceNode(!0, null, r.root)),
            this._.lastNode &&
            ...
            (this._.lastNode && r.root.contains(this._.lastNode)) ||
              ((this._.lastNode = this._.docEndMarker =
                r.document.createText("")),
        ...
        for (this._.nextNode = null; m; ) {
          ...
          if (J) m.type == CKEDITOR.NODE_TEXT && f.test(m.getText()) && (J = 0);
            ...
            if (
              ...
              m.isBlockBoundary(this.forceBrBreak && !y && { br: 1 })
            ) {
              if ("br" == p) J = 1;
          ...
          if (k && !M)
            for (; !m.getNext(g) && !t; ) {
              p = m.getParent();
              if (p.isBlockBoundary(this.forceBrBreak && !y && { br: 1 })) {
                M = 1;
                J = 0;
                t || p.equals(r);
          ...
          m = this._getNextSourceNode(m, E, r);
          if ((t = !m) || (M && k)) break;
        }
        if (!d) {
          if (!k)
          ...
          !m.equals(k.root)
            ...
            ? (k.checkStartOfBlock() && k.checkEndOfBlock()) ||
              ...
              k.insertNode(d))
            : t ||
              (this._.nextNode = d.equals(r)
                ? null
                : this._getNextSourceNode(k.getBoundaryNodes().endNode, 1, r));
        }
        z &&
          (z = d.getPrevious()) &&
        ...
        I &&
          ...
          z.type == CKEDITOR.NODE_ELEMENT &&
          "br" == z.getName() &&
          (!CKEDITOR.env.needsBrFiller || z.getPrevious(h) || z.getNext(h)) &&
          z.remove();
        this._.nextNode ||
          (this._.nextNode =
            t || d.equals(r) || !r ? null : this._getNextSourceNode(d, 1, r));
        return d;
      },
      _getNextSourceNode: function (a, b, c) {
        ...
        for (a = a.getNextSourceNode(b, null, d); !h(a); )
  ...
  (function () {
    function a(a, b, c, d, e) {
      ...
      for (f in b) {
        ...
        for (q in Q) {
          ...
          for (O in H)
            "!" == O.charAt(0) &&
              ((O = O.slice(1)), v.push(O), (g[O] = !0), (D = !1));
          for (; (O = v.pop()); ) (H[O] = H["!" + O]), delete H["!" + O];
          h[m] = (D ? !1 : g) || null;
        }
      ...
      for (d = a.length; c < d; ++c) {
        ...
        if (!0 === f.elements || null === f.elements)
          ...
          for (F in ((n = f.elements), delete f.elements, n))
            if (b[F]) b[F][p ? "unshift" : "push"](f);
            else b[F] = [f];
      }
    }
    function d(a, c, d, e) {
          ...
          if (
            ...
            if (a)
              if (!0 === a) a = !0;
                ...
                for (var f = 0, p = c.length, n; f < p; ++f)
                  (n = c[f]), e[n] || (e[n] = a(n));
                a = !1;
              }
            else a = !1;
    ...
    function e(a) {
      var b,
        ...
        f = {},
        p = 1;
      for (a = w(a); (b = a.match(n)); )
        (c = b[2])
          ? ((d = x(c, "styles")), (e = x(c, "attrs")), (c = x(c, "classes")))
          : (d = e = c = null),
          (f["$" + p++] = {
            elements: b[1],
            classes: c,
    ...
    function z(a, b, e, f) {
      var n = 0,
        w;
      f.toHtml && (b.name = b.name.replace(H, "$1"));
      if (f.doCallbacks && a.elementCallbacks) {
        a: {
          w = a.elementCallbacks;
          for (var q = 0, h = w.length, g; q < h; ++q)
            if ((g = w[q](b))) {
              w = g;
              break a;
            }
      ...
      if (f.doTransform && (w = a._.transformations[b.name])) {
        t(b);
        for (q = 0; q < w.length; ++q) p(a, b, w[q]);
        r(b);
      }
      if (f.doFilter) {
        a: {
          q = b.name;
          h = a._;
          a = h.allowedRules.elements[q];
          w = h.allowedRules.generic;
          q = h.disallowedRules.elements[q];
          ...
          if (a || w) {
            t(b);
            if (q)
              for (v = 0, C = q.length; v < C; ++v)
                if (!1 === c(q[v], b, k)) {
                  a = null;
                  break a;
                }
            if (h) for (v = 0, C = h.length; v < C; ++v) c(h[v], b, k);
            if (a) for (v = 0, C = a.length; v < C; ++v) d(a[v], b, k, g);
    ...
    function J(a) {
      return (
        a.type == CKEDITOR.NODE_ELEMENT && ("br" == a.name || q.$block[a.name])
      );
    }
    function E(a, b, c) {
      var d = a.name;
      if (q.$empty[d] || !a.children.length)
        "hr" == d && "br" == b
          ? a.replaceWith(y())
          : (a.parent && c.push({ check: "it", el: a.parent }), a.remove());
      else if (q.$block[d] || "tr" == d)
        if ("br" == b)
          a.previous && !J(a.previous) && ((b = y()), b.insertBefore(a)),
            a.next && !J(a.next) && ((b = y()), b.insertAfter(a)),
            ...
            for (
              ...
              (n = d[--p]),
                ...
                (n.type == CKEDITOR.NODE_TEXT ||
                  (n.type == CKEDITOR.NODE_ELEMENT && q.$inline[n.name]))
                  ? (w ||
                      ((w = new CKEDITOR.htmlParser.element(b)),
                      w.insertAfter(a),
                      c.push({ check: "parent-down", el: w })),
                    w.add(n, 0))
                  : ((w = null),
                    (h = q[e.name] || q.span),
                    n.insertAfter(a),
      ...
      for (f in d)
        if ("class" == f)
          for (
            ...
            if (-1 == n.indexOf(w)) return !1;
          }
        else if (a.attributes[f] != d[f]) return !1;
      for (p in e) if (a.styles[p] != e[p]) return !1;
      return !0;
    }
    function G(a, b) {
      var c, d;
      ...
      if (c && !b) {
        ...
        !0 === d
          ...
          : (d || (this.customConfig = !1),
            ...
            this.allow(
              v[c.enterMode] + " " + v[c.shiftEnterMode],
              "default",
              1,
            ),
    ...
    CKEDITOR.filter.prototype = {
      ...
      applyTo: function (a, b, c, d) {
        ...
        var e = this,
          ...
          n,
          w = !1,
          h = { doFilter: !c, doTransform: !0, doCallbacks: !0, toHtml: b };
        a.forEach(
          function (a) {
            if (a.type == CKEDITOR.NODE_ELEMENT) {
              ...
              a: {
                ...
                1 == d.children.length &&
                  (A = d.children[0]).type == CKEDITOR.NODE_ELEMENT &&
                  z(e, A, c, h);
                c = !c.length;
              }
              c || f.push(a);
        ...
        var g;
        a = [];
        d = v[d || (this.editor ? this.editor.enterMode : CKEDITOR.ENTER_P)];
        for (var k; (c = f.pop()); )
          c.type == CKEDITOR.NODE_ELEMENT ? E(c, d, a) : c.remove();
        for (; (g = a.pop()); )
          if (((c = g.el), c.parent))
            switch (((k = q[c.parent.name] || q.span), g.check)) {
              case "it":
                q.$removeEmpty[c.name] && !c.children.length
                  ? E(c, d, a)
                  : m(c) || E(c, d, a);
                break;
              case "el-up":
          ...
          for (b = 0; b < a.length && !e; ++b)
            (c = a[b]),
              ("string" == typeof c || c instanceof CKEDITOR.style) &&
                ...
                (e = c);
          if (e) {
            for (b = 0; b < a.length; ++b) d.push(G(a[b], e));
          ...
          for (e = 0; e < a.length; ++e) {
            ...
            for (p = 0; p < b.length; ++p)
              (n = b[p]),
                ...
                q instanceof CKEDITOR.style && (q = B(q)),
                c.push({
                  check: w == f ? null : w,
                  left: q,
                  right: "string" == typeof h ? N(h) : h,
                });
            b = f;
            d[b] || (d[b] = []);
            d[b].push(c);
      ...
      check: function (a, b, c) {
        ...
        if ("string" == typeof a) {
          ...
          w && (f.attributes.style = CKEDITOR.tools.writeCssText(f.styles));
        } else
          (f = a.getDefinition()),
            (w = f.styles),
            (d = f.attributes || {}),
            w && !CKEDITOR.tools.isEmpty(w)
              ? ((w = C(w)), (d.style = CKEDITOR.tools.writeCssText(w, !0)))
              : (w = {}),
            (f = {
              name: f.element,
              attributes: d,
        ...
        var w = CKEDITOR.tools.clone(f),
          q = [],
          h;
        if (!1 !== b && (h = this._.transformations[f.name])) {
          for (d = 0; d < h.length; ++d) p(this, f, h[d]);
          r(f);
        }
        z(this, w, q, {
          doFilter: !0,
        ...
        0 < q.length
          ? (c = !1)
          : ((b = f.attributes["class"]) &&
              (f.attributes["class"] = f.attributes["class"]
                .split(" ")
                .sort()
                .join(" ")),
            (c = CKEDITOR.tools.objectCompare(f.attributes, w.attributes, !0)),
            b && (f.attributes["class"] = b));
      ...
      transform: function (a, b) {
        if ("string" == typeof b) a.name = b;
          ...
          for (e in f)
            if ("class" == e)
              for (
                c = a.classes.join("|"), n = f[e].split(/\s+/);
                (w = n.pop());

              )
                -1 == c.indexOf(w) && a.classes.push(w);
  ...
  (function () {
    var a,
      d = function (b) {
        ...
        a ||
          (h && (a = !1 !== k.execCommand(h, { from: "keystrokeHandler" })),
                    ...
                    (8 >= CKEDITOR.env.version || CKEDITOR.env.ie9Compat)
                      ? (e.$.onreadystatechange = function () {
                          if (
                            ...
                            (e.$.onreadystatechange = null), t(b, !0);
                        })
                      : ((e.$.onload = function () {
                          setTimeout(function () {
                            e.$.onload = null;
  ...
  CKEDITOR.resourceManager.prototype = {
    ...
    load: function (a, d, b) {
      ...
      for (
        var c = this.loaded, f = this.registered, h = [], k = {}, g = {}, l = 0;
        l < a.length;
        l++
      ) {
        var u = a[l];
            ...
            a.call(
              ...
              function (a) {
                ...
                for (e in a) {
                  ...
                  if (!d[e]) {
                    if (g.icons)
                      for (var z = g.icons.split(","), I = z.length; I--; )
                        CKEDITOR.skin.addIcon(
                          z[I],
                          g.path +
                            "icons/" +
                            (CKEDITOR.env.hidpi && g.hidpi ? "hidpi/" : "") +
                            z[I] +
                            ".png",
                        );
  ...
  (function () {
    function a(a, e, f) {
      ...
      if (void 0 !== e) {
        ...
        if (
          CKEDITOR.env.ie &&
          CKEDITOR.env.quirks &&
          f == CKEDITOR.ELEMENT_MODE_INLINE
        )
        ...
        for (var p in b) {
          ...
          k &&
            ...
            0 <= CKEDITOR.tools.indexOf(k, a.langCode)
              ? (D = a.langCode)
              : ((D = a.langCode.replace(/-.*/, "")),
                (D =
                  D != a.langCode && 0 <= CKEDITOR.tools.indexOf(k, D)
                    ? D
                    : 0 <= CKEDITOR.tools.indexOf(k, "en")
                    ? "en"
                    : k[0])),
            h.langEntries && h.langEntries[D]
              ? ((a.lang[p] = h.langEntries[D]), (D = null))
              : f.push(CKEDITOR.getUrl(h.path + "lang/" + D + ".js")));
          e.push(D);
          d.push(h);
        }
            ...
            for (
              ...
              for (var p = 0; p < d.length; p++) {
                ...
                0 === f &&
                  ...
                  n.lang &&
                  n.langEntries &&
                  (a.lang[n.name] = n.langEntries[e[p]]);
                if (n[b[f]]) n[b[f]](a);
              }
            a.fireOnce("pluginsLoaded");
            c.keystrokes && a.setKeystroke(a.config.keystrokes);
            for (p = 0; p < a.config.blockedKeystrokes.length; p++)
              a.keystrokeHandler.blockedKeystrokes[
                a.config.blockedKeystrokes[p]
              ] = 1;
            a.status = "loaded";
            a.fireOnce("loaded");
    ...
    function z(a, b) {
      function c(a) {
        ...
        return b.is &&
          (b.is("tr") ||
            (b.is("td") && b.equals(d) && a.endOffset === b.getChildCount()))
          ? !0
          : !1;
      }
      function d(a) {
      ...
      for (
        var e = new CKEDITOR.dom.documentFragment(), f, h, g, k = 0;
        k < a.length;
        k++
      ) {
        var l = a[k],
        ...
        c(l)
          ? (f ||
              ((f = q.getAscendant("table").clone()),
              f.append(
                q.getAscendant({ thead: 1, tbody: 1, tfoot: 1 }).clone(),
              ),
              e.append(f),
              (f = f.findOne("thead, tbody, tfoot"))),
            (h && h.equals(q)) || ((h = q), (g = q.clone()), f.append(g)),
            g.append(d(l)))
    ...
    CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
      ...
      getCommandKeystroke: function (a, b) {
        ...
        if (c) {
          ...
          else for (var h in f) f[h] === e && d.push(h);
        }
        return b ? d : d[0] || null;
      },
      addFeature: function (a) {
  ...
  (function () {
    ...
    CKEDITOR.htmlParser.fragment.fromHtml = function (h, k, g) {
      function l(a) {
        var b;
        if (0 < m.length)
          for (var c = 0; c < m.length; c++) {
            ...
            (h && !h[e]) || (a && f && !f[a] && CKEDITOR.dtd[a])
              ? e == y.name && (x(y, y.parent, 1), c--)
              : (b || (u(), (b = 1)),
                (d = d.clone()),
                (d.parent = y),
                (y = d),
      ...
      function x(b, c, d) {
        ...
        var f = y;
        void 0 === b.previous &&
          (t(c, b) && ((y = c), I.onTagOpen(g, {}), (b.returnPoint = c = y)),
          e(b),
          (a(b) && !b.children.length) || c.add(b),
          "pre" == b.name && (E = !1),
          "textarea" == b.name && (J = !1));
        b.returnPoint
          ? ((y = b.returnPoint), delete b.returnPoint)
          : (y = d ? c : f);
      }
      function t(a, b) {
        if (
        ...
        if (a(f)) m.push(f);
          ...
          if ("br" == e) M.push(f);
            ...
            for (
              ...
              !((g = (h = y.name)
                ? CKEDITOR.dtd[h] ||
                  (y._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span)
                : c),
              f.isUnknown || y.isUnknown || g[e]);

            )
              if (y.isOptionalClose) I.onTagClose(h);
              else if (e in b && h in b)
                (h = y.children),
                  ((h = h[h.length - 1]) && "li" == h.name) ||
                    x((h = new CKEDITOR.htmlParser.element("li")), y),
                  !f.returnPoint && (f.returnPoint = y),
                  (y = h);
              else if (e in CKEDITOR.dtd.$listItem && !z(e, h))
                I.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1);
              else if (h in d && !z(e, h))
                !f.returnPoint && (f.returnPoint = y), (y = y.parent);
              else if ((h in CKEDITOR.dtd.$inline && m.unshift(y), y.parent))
                x(y, y.parent, 1);
              else {
                f.isOrphan = 1;
                break;
      ...
      I.onText = function (a) {
        if (
          !((y._.hasInlineStarted && !M.length) || E || J) &&
      ...
      exec: function (a, c) {
        ...
        for (x = 0; x < g; x++)
          if (
            ...
            (e = k[x]),
            !(
              (a.nonEditable && !e.options.applyToAll) ||
        ...
        for (var d = 0, h = this.rules, k = h.length, g; c && d < k; d++)
          (g = h[d]),
            (a.nonEditable && !g.options.applyToAll) ||
              ...
              (c = c.replace(g.value[0], g.value[1]));
        return c;
      },
    };
  })();
  (function () {
        ...
        return function (f) {
          if (f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
            var n = [],
              ...
              A;
            if (q)
              for (w(q, 1) && n.push(q); q; )
                h(q) &&
                  (g = c(q)) &&
                  w(g) &&
                  ((A = c(g)) && !h(A)
                    ? n.push(g)
                    : (e(p).insertAfter(g), g.remove())),
                  (q = q.previous);
      ...
      function w(a, b) {
        ...
        return a.type == CKEDITOR.NODE_TEXT &&
          ...
          (c.index &&
            ...
            (a.value = c[0])),
          (!CKEDITOR.env.needsBrFiller && p && (!b || a.parent.name in g)) ||
            (!p && (((c = a.previous) && "br" == c.name) || !c || h(c))))
          ? !0
          : !1;
      }
      var q = { elements: {} },
        p = "html" == d,
        g = CKEDITOR.tools.extend({}, D),
        v;
      for (v in g) "#" in E[v] || delete g[v];
      for (v in g) q.elements[v] = n(p, a.config.fillEmptyBlocks);
      q.root = n(p, !1);
    ...
    function h(a) {
      return (
        a &&
        ((a.type == CKEDITOR.NODE_ELEMENT && a.name in D) ||
    ...
    function u(a) {
      return a.replace(C, function (a, b, c) {
        return (
          "\x3c" +
          b +
          c.replace(w, function (a, b) {
            return v.test(b) && -1 == c.indexOf("data-cke-saved-" + b)
    ...
    function e(a, b) {
      return a.replace(b, function (a, b, c) {
        0 === a.indexOf("\x3ctextarea") &&
          (a =
            b +
            r(c).replace(/</g, "\x26lt;").replace(/>/g, "\x26gt;") +
            "\x3c/textarea\x3e");
        return (
    ...
    function I(a) {
      ...
      b = {
        htmlCode: "\x26#" + b + ";?",
        hex: "\x26#x0*" + c + ";?",
        entity: { "\x3c": "\x26lt;", "\x3e": "\x26gt;", ":": "\x26colon;" }[a],
      };
    ...
    CKEDITOR.htmlDataProcessor = function (b) {
      ...
      c.addRules(G);
      c.addRules(B, { applyToAll: !0 });
      c.addRules(a(b, "data"), { applyToAll: !0 });
      f.addRules(N);
      f.addRules(q, { applyToAll: !0 });
      ...
      b.on(
        ...
        function (a) {
          ...
          CKEDITOR.env.ie &&
            9 > CKEDITOR.env.version &&
            "pre" == f &&
            ((f = "div"), (c = "\x3cpre\x3e" + c + "\x3c/pre\x3e"), (n = 1));
          ...
          f &&
            ((n = c),
            !n.children.length &&
              CKEDITOR.dtd[n.name][f] &&
              ((f = new CKEDITOR.htmlParser.element(f)), n.add(f)));
          a.dataValue = c;
        },
        null,
        null,
    ...
    var y = /(?:&nbsp;|\xa0)$/,
      ...
      D = CKEDITOR.tools.extend({}, E.$blockLimit, E.$block),
      G = { elements: { input: g, textarea: g } },
      B = {
        attributeNames: [
          [/^on/, "data-cke-pa-on"],
    ...
    var C = /<(a|area|img|input|source)\b([^>]*)>/gi,
      ...
      O = new RegExp(
        "(" +
          z("\x3ccke:encoded\x3e") +
          "(.*?)" +
          z("\x3c/cke:encoded\x3e") +
          ")|(" +
          z("\x3c") +
          z("/") +
          "?" +
      ...
      H = /(<\/?)((?:object|embed|param|html|body|head|title)([\s][^>]*)?>)/gi,
        ...
        find: function (a, b) {
          ...
          for (k = 0; k < this.children.length; k++) {
            ...
            "function" == typeof a && a(g)
              ? d.push(g)
              : "string" == typeof a && g.name === a && d.push(g);
  ...
  (function () {
    ...
    CKEDITOR.inlineAll = function () {
      ...
      for (b in CKEDITOR.dtd.$editable)
        for (
          var c = CKEDITOR.document.getElementsByTag(b), f = 0, h = c.count();
          f < h;
          f++
        )
          (a = c.getItem(f)),
  ...
  (function () {
    function a(a) {
      ...
      k(b, e.block, f) &&
        q.collapsed &&
        !q.getCommonAncestor().isReadOnly() &&
        ((e = q.clone()),
      ...
      if (e.startPath().contains(f)) {
        ...
        if (d)
          return (
            (q = e.clone()),
            q.collapse(),
            q.setEndAt(d, CKEDITOR.POSITION_AFTER_END),
            (a = new CKEDITOR.dom.walker(q)),
            (a.guard = b(!0)),
            (d = !1),
            a.checkForward(),
        ...
        insertElementIntoRange: function (a, b) {
          ...
          b.startContainer.type == CKEDITOR.NODE_ELEMENT &&
            (b.startContainer.is({
              ...
              ? M(b)
              : b.startContainer.is(CKEDITOR.dtd.$list) && y(b));
          var g, w;
          if (f)
            for (
              ;
              (g = b.getCommonAncestor(0, 1)) &&
              (w = CKEDITOR.dtd[g.getName()]) &&
              (!w || !w[e]);
        ...
        extractHtmlFromRange: function (a, b) {
          ...
          if (b) {
            ...
            c.autoParagraph(this.editor, a),
              z(a.startContainer) && a.startContainer.appendBogus();
              ...
              q
                ? k != q.getText() &&
                  (CKEDITOR.env.ie && 9 > CKEDITOR.env.version
                    ...
                    : q.setText(k))
                : ((k = f.appendStyleText(k)),
                  (k = new CKEDITOR.dom.element(
                    k.ownerNode || k.owningElement,
                  )),
                  g.setCustomData("stylesheet", k),
                  k.data("cke-temp", 1));
            }
              ...
              if (0 !== b.getRanges().length) {
                if (c in C) {
                  ...
                  (e = h(b))
                    ...
                    : f.collapsed &&
                      ((g = q.block) &&
                      (l = g[c ? "getPrevious" : "getNext"](x)) &&
                      l.type == CKEDITOR.NODE_ELEMENT &&
                      l.is("table") &&
                      f[c ? "checkStartOfBlock" : "checkEndOfBlock"]()
                        ? (a.fire("saveSnapshot"),
                          f[c ? "checkEndOfBlock" : "checkStartOfBlock"]() &&
                            g.remove(),
                        ...
                        : q.blockLimit &&
                          ...
                          f.checkBoundaryOfElement(
                            k,
                            c ? CKEDITOR.START : CKEDITOR.END,
                          ) &&
                          (l = k[c ? "getPrevious" : "getNext"](x))
                        ? (a.fire("saveSnapshot"),
                          f["moveToElementEdit" + (c ? "End" : "Start")](l),
            ...
            CKEDITOR.env.gecko &&
              this.attachListener(this, "mouseup", function (b) {
                if (
                  2 == b.data.$.button &&
                  ((b = b.data.getTarget()),
                  !b.getAscendant("table") && !b.getOuterHtml().replace(r, ""))
                ) {
                  var c = a.createRange();
                    ...
                    if (d.collapsed)
                      a: {
                        ...
                        if (
                          ...
                          d.moveToClosestEditablePosition(f, !c) &&
                          d.collapsed
                        ) {
                          if (d.startContainer.type == CKEDITOR.NODE_ELEMENT) {
                            var n = d.startContainer.getChild(
                              d.startOffset - (c ? 1 : 0),
                            );
                            if (
                              n &&
    ...
    m = (function () {
                ...
                B && q in CKEDITOR.dtd.$list
                  ...
                  : ((g = !!k[q]),
                    "br" != q ||
                      ...
                      (C && C != l - 1) ||
                      ((Q =
                        (f = C ? h[C - 1].node : v.getItem(C + 1)) &&
                        (!a(f) || !f.is("br"))),
                      (f = f && a(f) && w.$block[f.getName()])),
                    -1 != m || g || (m = C),
                    g || (u = C),
                    h.push({
                      isElement: 1,
      ...
      function d(b, c) {
        var e = [],
          ...
          h = 0,
          k = w[c],
          C = !b.is(w.$inline) || b.is("br");
        for (C && e.push(" "); h < q; h++)
          (g = f.getItem(h)),
            a(g) && !g.is(k) ? (e = e.concat(d(g, c))) : e.push(g);
        C && e.push(" ");
        return e;
      }
      function e(b) {
      ...
      function f(b) {
        return (
          b &&
          a(b) &&
          (b.is(w.$removeEmpty) || (b.is("a") && !b.isBlockBoundary()))
        );
      }
      function q(b, c, d, e) {
        var f = b.clone(),
        ...
        (g = new CKEDITOR.dom.walker(f).next()) &&
          a(g) &&
          v[g.getName()] &&
          (h = g.getPrevious()) &&
          a(h) &&
          !h.getParent().equals(b.startContainer) &&
          d.contains(h) &&
          e.contains(g) &&
          g.isIdentical(h) &&
          (g.moveChildren(h), g.remove(), q(b, c, d, e));
      }
      function h(b, c) {
        function d(b, c) {
          if (
      ...
      var w = CKEDITOR.dtd,
        ...
        m = { p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1 },
        u = CKEDITOR.tools.extend({}, w.$inline);
      delete u.br;
      return function (n, v, H, F) {
        var K = n.editor,
          A = !1;
        "unfiltered_html" == v && ((v = "html"), (A = !0));
        if (!F.checkReadOnly()) {
          var t =
            new CKEDITOR.dom.elementPath(F.startContainer, F.root).blockLimit ||
            F.root;
          v = {
            type: v,
            dontFilter: A,
          ...
          var A = v.range,
            ...
            U;
          "text" == v.type &&
            A.shrink(CKEDITOR.SHRINK_ELEMENT, !0, !1) &&
            ((x = CKEDITOR.dom.element.createFromHtml(
              "\x3cspan\x3e\x26nbsp;\x3c/span\x3e",
              A.document,
            )),
            A.insertNode(x),
          ...
          v.endPath = y = new CKEDITOR.dom.elementPath(A.endContainer);
          if (!A.collapsed) {
            r = y.block || y.blockLimit;
          ...
          for (; (I = e(A)) && a(I) && I.isBlockBoundary() && z.contains(I); )
            A.moveToPosition(I, CKEDITOR.POSITION_BEFORE_END);
          q(A, v.blockLimit, z, y);
          x && (A.setEndBefore(x), A.collapse(), x.remove());
          x = A.startPath();
          if ((r = x.contains(f, !1, 1)))
            (U = A.splitElement(r)),
              (v.inlineStylesRoot = r),
              (v.inlineStylesPeak = x.lastElement);
          x = A.createBookmark();
          L && (l(r), l(U));
          (r = x.startNode.getPrevious(c)) && a(r) && f(r) && t.push(r);
          (r = x.startNode.getNext(c)) && a(r) && f(r) && t.push(r);
          for (r = x.startNode; (r = r.getParent()) && f(r); ) t.push(r);
          A.moveToBookmark(x);
          K.enterMode === CKEDITOR.ENTER_DIV &&
            "" === K.getData(!0) &&
            ((K = n.getFirst()) && K.remove(),
            F.setStartAt(n, CKEDITOR.POSITION_AFTER_START),
            F.collapse(!0));
          if ((n = H)) {
            n = v.range;
            if ("text" == v.type && v.inlineStylesRoot) {
              F = v.inlineStylesPeak;
              K = F.getDocument().createText("{cke-peak}");
              for (U = v.inlineStylesRoot.getParent(); !F.equals(U); )
                (K = K.appendTo(F.clone())), (F = F.getParent());
              H = K.getOuterHtml().split("{cke-peak}").join(H);
            }
            F = v.blockLimit.getName();
            if (/^\s+|\s+$/.test(H) && "span" in CKEDITOR.dtd[F]) {
              var J =
                '\x3cspan data-cke-marker\x3d"1"\x3e\x26nbsp;\x3c/span\x3e';
              H = J + H + J;
            }
            H = v.editor.dataProcessor.toHtml(H, {
              context: null,
              fixForBody: !1,
              protectedWhitespaces: !!J,
              dontFilter: v.dontFilter,
              filter: v.editor.activeFilter,
              enterMode: v.editor.activeEnterMode,
            });
            F = n.document.createElement("body");
            F.setHtml(H);
            J && (F.getFirst().remove(), F.getLast().remove());
            if (
              (J = n.startPath().block) &&
          ...
          if (n) {
            ...
            var Y,
              K = P.startContainer;
            I = v.endPath.elements[0];
            var Z,
              A = I.getPosition(K),
              t =
                !!I.getCommonAncestor(K) &&
                A != CKEDITOR.POSITION_IDENTICAL &&
                !(
                  A &
                  (CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED)
                ),
              K = b(v.dataWrapper, v);
            for (h(K, P); U < K.length; U++) {
              A = K[U];
              if ((L = A.isLineBreak))
                (L = P),
                  (r = F),
                  ...
                  A.hasBlockSibling
                    ? (L = 1)
                    : (z = L.startContainer.getAscendant(w.$block, 1)) &&
                      z.is({ div: 1, p: 1 })
                    ? ((y = z.getPosition(r)),
                      y == CKEDITOR.POSITION_IDENTICAL ||
                      y == CKEDITOR.POSITION_CONTAINS
                        ? (L = 0)
                        : ((r = L.splitElement(z)),
                          L.moveToPosition(r, CKEDITOR.POSITION_AFTER_START),
                          (L = 1)))
                    : (L = 0);
              if (L) H = 0 < U;
              else {
                L = P.startPath();
                !A.isBlock &&
                  k(v.editor, L.block, L.blockLimit) &&
                  (M = g(v.editor)) &&
                  ((M = n.createElement(M)),
                  M.appendBogus(),
                  P.insertNode(M),
                  CKEDITOR.env.needsBrFiller &&
                    (R = M.getBogus()) &&
                    R.remove(),
                  P.moveToPosition(M, CKEDITOR.POSITION_BEFORE_END));
                if ((L = P.startPath().block) && !L.equals(E)) {
                ...
                if (x && A.isElement) {
                  L = P.startContainer;
                  for (r = null; L && !w[L.getName()][A.name]; ) {
                    if (L.equals(F)) {
                      L = null;
                      break;
                    }
                  ...
                  if (L)
                    ...
                    z = [];
                    y = r.length;
                    for (var aa = 0, ca = void 0, W = 0, V = -1; aa < y; aa++)
                      (ca = r[aa]),
                        " " == ca
                          ? (W ||
                              (Z && !aa) ||
                ...
                A.lastNotAllowed &&
                  U < K.length - 1 &&
                  ((Y = t ? I : Y) &&
                    P.setEndAt(Y, CKEDITOR.POSITION_AFTER_START),
                  (x = 0));
                P.collapse();
              }
            }
            ...
            R &&
              ((H = !0),
              (L = K[0].node),
              P.setStartAt(L, CKEDITOR.POSITION_BEFORE_START),
              P.setEndAt(L, CKEDITOR.POSITION_AFTER_END));
            v.dontMoveCaret = H;
            v.bogusNeededBlocks = J;
          }
          R = v.range;
          var X;
          Y = v.bogusNeededBlocks;
          for (Z = R.createBookmark(); (E = v.zombies.pop()); )
            E.getParent() &&
              ((M = R.clone()),
              M.moveToElementEditStart(E),
              M.removeEmptyBlocksAtEnd());
          if (Y)
            for (; (E = Y.pop()); )
              CKEDITOR.env.needsBrFiller
                ? E.appendBogus()
                : E.append(R.document.createText(" "));
          for (; (E = v.mergeCandidates.pop()); ) E.mergeSiblings();
          R.moveToBookmark(Z);
          if (!v.dontMoveCaret) {
            for (E = e(R); E && a(E) && !E.is(w.$empty); ) {
              if (E.isBlockBoundary())
                R.moveToPosition(E, CKEDITOR.POSITION_BEFORE_END);
              else {
                if (f(E) && E.getHtml().match(/(\s|&nbsp;)$/g)) {
                  X = null;
                  break;
                }
                X = R.clone();
                X.moveToPosition(E, CKEDITOR.POSITION_BEFORE_END);
              }
              E = E.getLast(c);
            }
            X && R.moveToRange(X);
      ...
      return function (d) {
        ...
        f.is("table")
          ...
          : (f.is({ tbody: 1, thead: 1, tfoot: 1 }) && (f = b(f, "tr", g)),
            f.is("tr") &&
              (f = b(f, f.getParent().is("thead") ? "th" : "td", g)),
      ...
      return {
        list: {
          detectMerge: function (a, b) {
            ...
            a.mergeList =
              g && h && g.getParent().equals(h.getParent()) && !g.equals(h);
            a.mergeListItems =
              e.block &&
              f.block &&
              e.block.is(CKEDITOR.dtd.$listItem) &&
            ...
            detectRanges: function (e, f) {
              ...
              if (l || n)
                l && n && b(l, n)
                  ...
                  : ((e.tableSurroundingRange = h),
                    h.setEndAt(n, CKEDITOR.POSITION_BEFORE_START),
                    g.setStartAt(n, CKEDITOR.POSITION_AFTER_START)),
                  (e.tableContentsRanges = k ? k : a(g));
            },
            deleteRanges: function (a) {
              for (var b; (b = a.tableContentsRanges.pop()); )
                b.extractContents(),
                  z(b.startContainer) && b.startContainer.appendBogus();
  ...
  (function () {
    ...
    function d(b, c) {
      ...
      if ((d = !c && 1 === b.length) && !(d = b[0].collapsed)) {
        var f = b[0];
        d = f.startContainer.getAscendant({ td: 1, th: 1 }, !0);
        var g = f.endContainer.getAscendant({ td: 1, th: 1 }, !0);
        e = CKEDITOR.tools.trim;
        d && d.equals(g) && !d.findOne("td, th, tr, tbody, table")
          ? ((f = f.cloneContents()),
            (d = f.getFirst()
              ? e(f.getFirst().getText()) !== e(d.getText())
              : !0))
          : (d = !1);
      }
      if (d) return !1;
    ...
    function c(a) {
      ...
      for (f = 0; f < a.length; f++)
        e && !e.equals(a[f].getAscendant("tr"))
          ? ((c += d.join("\t") + "\n"),
            (e = a[f].getAscendant("tr")),
            (d = []))
          : 0 === f && (e = a[f].getAscendant("tr")),
          d.push(a[f].getText());
      return (c += d.join("\t"));
    }
    function f(a) {
        ...
        if (!(e = !c) && (e = !c.isHidden())) {
          ...
          if (a(e.getSelectedElement())) e = !1;
            ...
            var l = 1 === f.length && f[0].collapsed,
              g = d(f, !!CKEDITOR.env.webkit) && d(g);
            h = h && n ? h.equals(n) || n.contains(h) : !1;
            h && (l || g) ? (k && !H && e.selectRanges(f), (e = !0)) : (e = !1);
          }
          e = !e;
        }
        e && (b.reset(), (b = 0));
    ...
    function g() {
      p = null;
      D && (CKEDITOR.tools.setTimeout(h, 0, this), (D = !1));
    }
    function l(a) {
      return G(a) ||
      ...
      for (var b = 0; b < a.length; b++) {
        ...
        if (!c.collapsed) {
          ...
          e &&
            ...
            (g ? h.setEndAfter(e) : h.setEndBefore(e));
    ...
    var m = "function" != typeof window.getSelection,
      ...
      p,
      D,
      G = CKEDITOR.dom.walker.invisible(1),
      B = (function () {
        function a(b) {
          return function (a) {
    ...
    CKEDITOR.on("instanceCreated", function (a) {
      ...
      c.on("contentDom", function () {
        ...
        g.attachListener(
          ...
          function () {
            if (C && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) {
              C =
                c._.previousActive && c._.previousActive.equals(e.getActive());
              var a =
                null != c._.previousScrollTop &&
                c._.previousScrollTop != g.$.scrollTop;
              CKEDITOR.env.webkit &&
                C &&
                a &&
                (g.$.scrollTop = c._.previousScrollTop);
            }
            c.unlockSelection(C);
            C = 0;
          },
        ...
        if (CKEDITOR.env.ie || CKEDITOR.env.gecko || A)
          m
            ? g.attachListener(g, "beforedeactivate", a, null, null, -1)
            : g.attachListener(c, "selectionCheck", a, null, null, -1),
            g.attachListener(
              g,
              CKEDITOR.env.webkit || CKEDITOR.env.gecko ? "focusout" : "blur",
              function () {
                var a = p && (p.isFake || 2 > p.getRanges().length);
                (CKEDITOR.env.gecko && !A && a) ||
                  (c.lockSelection(p), (C = 1));
              },
              null,
              null,
              -1,
          ...
          g.attachListener(g, "mousedown", function (a) {
            2 == a.data.$.button &&
              (((a = c.document.getSelection()) &&
                ...
                (u = c.window.getScrollPosition()));
          });
          g.attachListener(g, "mouseup", function (a) {
            2 == a.data.$.button &&
              u &&
              ((c.document.$.documentElement.scrollLeft = u.x),
              (c.document.$.documentElement.scrollTop = u.y));
            u = null;
          });
              ...
              l.on("mousedown", function (a) {
                function b(a) {
                  ...
                  if (r) {
                    ...
                    r.setEndPoint(
                      0 > t.compareEndPoints("StartToStart", c)
                        ? "EndToEnd"
                        : "StartToStart",
                      c,
                    );
        ...
        if (A && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) {
          ...
          g.attachListener(
            CKEDITOR.env.ie ? g : e.getDocumentElement(),
            "mouseup",
            k,
            c,
          );
    ...
    CKEDITOR.dom.selection.prototype = {
        ...
        : function () {
            ...
            if (!c || !c.rangeCount) b = CKEDITOR.SELECTION_NONE;
              ...
              d == c.endContainer &&
                ...
                N[d.childNodes[c.startOffset].nodeName.toLowerCase()] &&
        ...
        var a = m
          ? (function () {
              ...
              var b = function (b, c) {
                ...
                for (; 0 < h; )
                  try {
                    (g = f[0 < m ? "previousSibling" : "nextSibling"]),
                      g.nodeType == CKEDITOR.NODE_TEXT &&
                        ((h -= g.nodeValue.length), (p = g)),
                      (f = g);
                  } catch (u) {
                  ...
                  for (var d = [], e = 0; e < c.length; e++) {
                    for (
                      var f = c.item(e),
                        ...
                        h = 0,
                        a = new CKEDITOR.dom.range(this.root);
                      h < g.childNodes.length && g.childNodes[h] != f;
                      h++
                    );
      ...
      unlock: function (a) {
        if (this.isLocked) {
          ...
          a &&
            ...
            (this.root.editor.plugins.tableselection && d(c)
              ? f.call(this, c)
              : e
              ? this.fake(b)
              : b && 2 > c.length
      ...
      selectRanges: function (a) {
        ...
        this.reset();
        if (c)
          for (var c = this.root, g, h = 0; h < a.length; ++h)
            (g = a[h]),
              g.endContainer.equals(c) &&
                (g.endOffset = Math.min(g.endOffset, c.getChildCount()));
        if (a.length)
          if (this.isLocked) {
            ...
            a: {
              ...
              if (
                ...
                n.type == CKEDITOR.NODE_ELEMENT &&
                ((H = H.clone()),
                H.shrink(CKEDITOR.SHRINK_ELEMENT, !0),
                (l = H.getEnclosedNode()) &&
                  l.type == CKEDITOR.NODE_ELEMENT &&
                  (n = l),
            ...
            if (n) this.fake(n);
              ...
              b.plugins.tableselection.isSupportedEnvironment() &&
              d(a) &&
              !E &&
              !a[0]
              ...
              if (m) {
                ...
                if (
                  (b.startContainer.type == CKEDITOR.NODE_ELEMENT &&
                    b.startContainer.getName() in H) ||
                  (b.endContainer.type == CKEDITOR.NODE_ELEMENT &&
                    b.endContainer.getName() in H)
                )
                ...
                k
                  ? ((n = b.document.$.body.createTextRange()),
                    n.moveToElementText(k.$),
                    A.setEndPoint("EndToEnd", n),
                    A.moveEnd("character", -1))
                  : ((F = H.getNext(l)),
                    (p = H.hasAscendant("pre")),
                    (F =
                      !(F && F.getText && F.getText().match(n)) &&
                      (p ||
                        !H.hasPrevious() ||
                        (H.getPrevious().is && H.getPrevious().is("br")))),
                    (p = b.document.createElement("span")),
                    p.setHtml("\x26#65279;"),
                    p.insertBefore(H),
                    F && b.document.createText("﻿").insertBefore(H));
                b.setStartBefore(H);
                H.remove();
                a
                  ? (F
                ...
                for (A = 0; A < a.length; A++) {
                  if (
                    ...
                    (p = a[A + 1]),
                    (n = F.clone()),
                    n.setStart(F.endContainer, F.endOffset),
                    n.setEnd(p.startContainer, p.startOffset),
                    !n.collapsed &&
                      (n.shrink(CKEDITOR.NODE_ELEMENT, !0),
                      (b = n.getCommonAncestor()),
                      (n = n.getEnclosedNode()),
                      b.isReadOnly() || (n && n.isReadOnly())))
                  ) {
                    p.setStart(F.startContainer, F.startOffset);
                    a.splice(A--, 1);
                    continue;
                  }
                  b = a[A];
                  ...
                  b.collapsed &&
                    ...
                    "br" == F.getName()
                      ...
                      : b.moveToPosition(n, CKEDITOR.POSITION_AFTER_END));
                  ...
                  try {
                    ...
                    if (0 <= t.toString().indexOf("NS_ERROR_ILLEGAL_VALUE"))
                      b.collapse(1), p.setEnd(b.endContainer.$, b.endOffset);
                    else throw t;
                  }
                  k.addRange(p);
                }
  ...
  (function () {
        ...
        for (t.getPosition(r) == CKEDITOR.POSITION_FOLLOWING && (t = 0); t; ) {
          ...
          if (t.equals(r)) (t = null), (l = !0);
            ...
            var z = t.type == CKEDITOR.NODE_ELEMENT ? t.getName() : null,
              ...
              y = z && t.getAttribute("data-nostyle");
            if (
            ...
            if (v && m && CKEDITOR.dtd.$block[z])
              for (
                var D = t,
                  ...
                  E = B.length,
                  G = 0,
                  D = E && new CKEDITOR.dom.range(D.getDocument());
                G < E;
                ++G
              ) {
                var C = B[G],
                  J = CKEDITOR.filter.instances[C.data("cke-filter")];
                if (J ? J.check(this) : 1)
                  D.selectNodeContents(C), b.call(this, D);
              }
            B = z ? (!p[z] || y ? 0 : v && !m ? 0 : d(t, r, h, Q)) : 1;
            if (B)
              if (
                ((C = t.getParent()),
                (B = h),
                ...
                (G = k),
                !C ||
                  (!(C.getDtd() || CKEDITOR.dtd.span)[E] && !G) ||
                  (B.parentRule && !B.parentRule(C)))
              )
                l = !0;
              else {
                if (
            ...
            for (
              ...
              if (y.getName() == g) {
                for (W in h.attributes)
                  !E[W] &&
                    (X = y.getAttribute(V)) &&
                    (l.getAttribute(W) == X ? (B[W] = 1) : (E[W] = 1));
                for (V in h.styles)
                  !C[V] &&
                    (X = y.getStyle(V)) &&
                    (l.getStyle(V) == X ? (z[V] = 1) : (C[V] = 1));
              }
              y = y.getParent();
            }
            for (W in B) l.removeAttribute(W);
            for (V in z) l.removeStyle(V);
            v && !l.hasAttributes() && (l = null);
            l
              ? (x.extractContents().appendTo(l),
                x.insertNode(l),
                I.call(this, l),
                l.mergeSiblings(),
    ...
    function c(a) {
      function b() {
        for (
          var a = new CKEDITOR.dom.elementPath(d.getParent()),
            c = new CKEDITOR.dom.elementPath(m.getParent()),
            e = null,
            f = null,
            g = 0;
          g < a.elements.length;
      ...
      if (a.collapsed) {
        for (
          var f = new CKEDITOR.dom.elementPath(d.getParent(), a.root),
            g,
            h = 0,
            k;
          h < f.elements.length &&
          ...
          if (this.checkElementRemovable(k)) {
            ...
            (a.checkBoundaryOfElement(k, CKEDITOR.END) ||
              ...
              ? ((g = k), (g.match = l ? "start" : "end"))
              : (k.mergeSiblings(),
                k.is(this.element)
                  ? z.call(this, k)
                  : r(k, E(this)[k.getName()]));
          }
        if (g) {
          e = d;
          for (h = 0; ; h++) {
    ...
    function z(a, b) {
      ...
      for (g in d)
        if (
          ...
          a.getAttribute(g) == p(g, d[g])
        )
          (b && "data-" == g.slice(0, 5)) ||
            ((f = a.hasAttribute(g)), a.removeAttribute(g));
      for (var h in c)
        (this._.definition.fullMatch && a.getStyle(h) != p(h, c[h], !0)) ||
      ...
      for (var f in b)
        if (f != this.element)
          for (c = a.getElementsByTag(f), e = c.count() - 1; 0 <= e; e--)
            (d = c.getItem(e)), d.isReadOnly() || r(d, b[f]);
    }
    function r(a, b, c) {
      if ((b = b && b.attributes))
    ...
    function G(a, b, c) {
      ...
      for (var e, f = d.createIterator(); (e = f.getNextRange()); )
        b.call(this, e, c);
      a.selectRanges(d);
    }
    var B = {
      ...
      q = /\s*(?:;\s*|$)/,
      C = /#\((.+?)\)/g,
      w = CKEDITOR.dom.walker.bookmark(0, 1),
    ...
    CKEDITOR.style.prototype = {
      apply: function (a) {
        if (a instanceof CKEDITOR.dom.document)
          return G.call(this, a.getSelection());
        if (this.checkApplicable(a.elementPath(), a)) {
          var b = this._.enterMode;
          b || (this._.enterMode = a.activeEnterMode);
          G.call(this, a.getSelection(), 0, a);
          this._.enterMode = b;
        }
      },
      remove: function (a) {
        if (a instanceof CKEDITOR.dom.document)
          return G.call(this, a.getSelection(), 1);
        if (this.checkApplicable(a.elementPath(), a)) {
          var b = this._.enterMode;
          b || (this._.enterMode = a.activeEnterMode);
          G.call(this, a.getSelection(), 1, a);
          this._.enterMode = b;
        }
      },
    ...
    attachStyleStateChange: function (a, d) {
      ...
      b ||
        ...
        this.on("selectionChange", function (a) {
          for (var d = 0; d < b.length; d++) {
            var h = b[d],
              k = h.style.checkActive(a.data.path, this)
  ...
  (function () {
    ...
    CKEDITOR.dom.selection.prototype.optimizeInElementEnds = function () {
      ...
      h &&
        ((h = b.clone()),
        b.shrink(CKEDITOR.SHRINK_TEXT, !1, { skipBogus: !0 }),
        (d = !1),
        a(f, b, h),
        b.select(),
        (d = !0));
    ...
    split: function (a) {
      ...
      d.childNodes.length == b &&
        (a >= c
          ...
          : ((a = f.createText("")), a.insertAfter(h), a.remove()));
      return h;
    },
        ...
        return {
          getNextRange: function (k) {
            ...
            if (g && 1 < a.length) {
              ...
              for (g.moveToBookmark(d.shift()); u--; )
                (l = a[++h]),
                  l.moveToBookmark(d.shift()),
                  g.setEnd(l.endContainer, l.endOffset);
            }
            return g;
          },
        };
  ...
  (function () {
    ...
    function f(a, b, c) {
      var d, f, g;
      if (CKEDITOR.env.webkit)
        for (b = b.split("}").slice(0, -1), f = 0; f < b.length; f++)
          b[f] = b[f].split("{");
      ...
      setUiColor: function (a) {
        ...
        return (this.setUiColor = function (a) {
          ...
          var c = CKEDITOR.skin.chameleon,
            ...
            h = "";
          "function" == typeof c &&
            ((d = c(this, "editor")), (h = c(this, "panel")));
          a = [[l, a]];
          f([b], d, a);
          f(g, h, a);
        }).call(this, a);
...
*/
  ...
  (function () {
    ...
    function K(a, b) {
      for (
        var c = a.$.getElementsByTagName("input"), d = 0, e = c.length;
        d < e;
        d++
      ) {
    ...
    function Y(a) {
      var b = CKEDITOR.dom.element.createFromHtml(
          CKEDITOR.addTemplate("dialog", Z).output({
    ...
    function M(a, b) {
      this.dialog = a;
      for (var c = b.contents, d = 0, e; (e = c[d]); d++)
        c[d] = e && new N(a, e);
    ...
    function ba(a) {
      function b(b) {
        ...
        q =
          e.x + h[3] < g
            ? -h[3]
            : e.x - h[1] > k.width - c.width - g
            ? k.width - c.width + ("rtl" == f.lang.dir ? 0 : h[1])
            : e.x;
        c =
          e.y + h[0] < g
            ? -h[0]
            : e.y - h[2] > k.height - c.height - g
    ...
    function ca(a) {
      function b(b) {
        ...
        if (
          ...
          q = Math.max(d.minWidth || 0, w - g);
        if (
          e == CKEDITOR.DIALOG_RESIZE_HEIGHT ||
          e == CKEDITOR.DIALOG_RESIZE_BOTH
        )
          l = Math.max(d.minHeight || 0, C - h);
        a.resize(q, l);
        ...
        var f = a.getParentEditor(),
          ...
          l = CKEDITOR.tools.addFunction(function (e) {
            ...
            l &&
              ...
              f.append(q));
            h = k.height - a.parts.contents.getFirst(d).getSize("height", w);
            g = k.width - a.parts.contents.getFirst(d).getSize("width", 1);
    ...
    function O(a, b, c) {
      var d = a.parts.dialog.getParent().getClientSize(),
        e = a.getSize(),
        f = a._.viewportRatio,
        g = Math.max(d.width - e.width, 0),
        d = Math.max(d.height - e.height, 0);
      f.width = g ? b / g : f.width;
      f.height = d ? c / d : f.height;
      a._.viewportRatio = f;
    }
    function J(a) {
    ...
    function P(a) {
      ...
      f
        ...
        : ((e = [
          ...
          e.push("\x3c/div\x3e"),
          (f = CKEDITOR.dom.element.createFromHtml(e.join(""))),
    ...
    function da(a) {
      for (var b in x) {
        for (var c = x[b], d = c.length - 1; 0 <= d; d--)
    ...
    var y = CKEDITOR.tools.cssLength,
      U,
      u,
      F = !CKEDITOR.env.ie || CKEDITOR.env.edge,
      Z =
        ...
        (F ? "margin:auto" : "position:absolute") +
    ...
    CKEDITOR.dialog = function (a, b) {
      ...
      function d(a) {
        ...
        if (!(1 > b.length)) {
          ...
          do {
            d += a;
            if (g && !n._.tabBarMode && (d == b.length || -1 == d)) {
              n._.tabBarMode = !0;
      ...
      function e(b) {
        if (n == CKEDITOR.dialog._.currentTop) {
          ...
          if (9 == c || c == CKEDITOR.SHIFT + 9)
            ...
            (c =
              -1 != CKEDITOR.tools.indexOf([e ? 39 : 37, 38], c)
                ? A.call(n)
                : V.call(n)),
              n.selectPage(c),
              n._.tabs[c][0].focus(),
      ...
      this.on("show", function () {
        B.on("keydown", e, this);
        if (CKEDITOR.env.gecko) B.on("keypress", f, this);
      });
      this.on("hide", function () {
        B.removeListener("keydown", e);
        ...
        function () {
          ...
          a.config.dialog_startupFocusTab && b
            ...
            : this._.hasFocus ||
              ...
              g.onFocus ? (b = g.onFocus.call(this)) && b.focus() : d(1));
        },
        this,
        null,
        4294967295,
    ...
    CKEDITOR.dialog.prototype = {
      ...
      move: function (a, b, c) {
        ...
        this._.position && this._.position.x == a && this._.position.y == b
          ? ((a = Math.floor(p * h.width)), (b = Math.floor(f * h.height)))
          : O(this, a, b);
      ...
      show: function () {
        var a = this._.element,
          ...
          d = this._.editor.config.baseFloatZIndex;
        a.getParent() && a.getParent().equals(c)
          ? a.setStyle("display", F ? "flex" : "block")
          : a.appendTo(c);
        this.resize(
        ...
        null === CKEDITOR.dialog._.currentZIndex &&
          (CKEDITOR.dialog._.currentZIndex = d);
        this._.element
          .getFirst()
      ...
      layout: function () {
        ...
        if (this._.moved || !F) {
          ...
          this._.moved && this._.position
            ? ((d = this._.position.x), (b = this._.position.y))
            : ((d = (c.width - b.width) / 2), (b = (c.height - b.height) / 2));
          CKEDITOR.env.ie6Compat ||
      ...
      hide: function () {
        if (this.parts.dialog.isVisible()) {
          ...
          for (da(this); CKEDITOR.dialog._.currentTop != this; )
        ...
        if (
          ...
          for (
            var b = [],
              c = a.label
                ...
                : "",
              d = CKEDITOR.dialog._.uiElementBuilders.vbox.build(
                this,
                {
                  type: "vbox",
            ...
            d.notAllowed || "hbox" == d.type || "vbox" == d.type || g++,
              (e[d.id] = d),
          ...
          c = CKEDITOR.dom.element.createFromHtml(
            [
              ...
              e,
              '"',
              d.gecko && !d.hc ? "" : ' href\x3d"javascript:void(0)"',
          ...
          a.accessKey &&
            (T(this, this, "CTRL+" + a.accessKey, fa, ea),
      ...
      hidePage: function (a) {
        ...
        b &&
          1 != this._.pageCount &&
          b.isVisible() &&
          (a == this._.currentTabId && this.selectPage(A.call(this)),
          b.hide(),
          this._.pageCount--,
          this.updateStyle());
      },
    ...
    var G = function (a, b, c) {
        for (var d = 0, e; (e = a[d]); d++)
          if (e.id == b || (c && e[c] && (e = G(e[c], b, c)))) return e;
        return null;
      },
      H = function (a, b, c, d, e) {
        if (c) {
          for (var f = 0, g; (g = a[f]); f++) {
            ...
            if (d && g[d] && (g = H(g[d], b, c, d, !0))) return g;
          }
          if (e) return null;
        }
        a.push(b);
        ...
        uiElement: function (a, b, c, d, e, f, g) {
          if (!(4 > arguments.length)) {
            var h = (d.call ? d(b) : d) || "div",
              ...
              l = (this.domId =
                k.id || CKEDITOR.tools.getNextId() + "_uiElement");
            b.requiredContent &&
            ...
            for (
              var n =
                  k["class"] && k["class"].split ? k["class"].split(" ") : [],
                l = 0;
              l < n.length;
              l++
            )
            ...
            b.align &&
              ((n = b.align),
              (m["margin-left"] = "left" == n ? 0 : "auto"),
              (m["margin-right"] = "right" == n ? 0 : "auto"));
            ...
            for (l in k)
              p.push(l + '\x3d"' + CKEDITOR.tools.htmlEncode(k[l]) + '" ');
            ...
            CKEDITOR.ui.dialog.uiElement.call(
              ...
              function () {
                ...
                for (p = 0; p < c.length; p++) {
                  ...
                  g
                    ? g[p] && d.push("width:" + y(g[p]))
                    : d.push("width:" + Math.floor(100 / c.length) + "%");
                  h && d.push("height:" + y(h));
                  e &&
                    void 0 !== e.padding &&
                    d.push("padding:" + y(e.padding));
                  CKEDITOR.env.ie &&
                    CKEDITOR.env.quirks &&
                    f[p].align &&
                    d.push("text-align:" + f[p].align);
            ...
            CKEDITOR.ui.dialog.uiElement.call(
              ...
              function () {
                ...
                for (var d = 0; d < c.length; d++) {
                  ...
                  e &&
                    void 0 !== e.padding &&
                    k.push("padding:" + y(e.padding));
                  CKEDITOR.env.ie &&
                    CKEDITOR.env.quirks &&
                    f[d].align &&
                    k.push("text-align:" + f[d].align);
        ...
        for (e in a)
          if ((c = e.match(b)))
            this.eventProcessors[e]
              ...
              : d(this, this._.dialog, c[1].toLowerCase(), a[e]);
        return this;
      },
      eventProcessors: {
        onLoad: function (a, b) {
        ...
        functions: function () {
          ...
          return function () {
            ...
            for (f = 0; f < e.length; f++)
              l = d == CKEDITOR.VALIDATE_AND ? l && e[f](b) : l || e[f](b);
            return l ? !0 : c;
          };
        },
        regex: function (a, b) {
      ...
      openDialog: function (a, b, c) {
        ...
        if ("function" == typeof e)
          (e = this._.storedDialogs || (this._.storedDialogs = {})),
            (d = e[a] || (e[a] = new CKEDITOR.dialog(this, a))),
            d.setModel(c),
            b && b.call(d, d),
            d.show();
        else {
  ...
  (function () {
    ...
    CKEDITOR.ui.button.prototype = {
      render: function (a, b) {
        ...
        d
          ? (l = a.getCommandKeystroke(d)) &&
            (m = CKEDITOR.tools.keystrokeToString(a.lang.common.keyboard, l))
          : (g += "off");
  ...
  (function () {
    ...
    function x(a) {
      function b() {
        ...
        "beforepaste" == p.mainPasteEvent &&
          (b.on("paste", function (a) {
            v || (f(), a.data.preventDefault(), k(a), e("paste"));
          }),
          b.on("contextmenu", h, null, null, 0),
          b.on(
            "beforepaste",
            function (a) {
          ...
          exec: function (a, b) {
            function c(b, g) {
              ...
              b
                ? ((b.method = "paste"),
                  b.dataTransfer ||
                    (b.dataTransfer = p.initPasteDataTransfer()),
                  r(a, b, g))
                : e &&
            ...
            var d = this,
              ...
              g = b.type,
              m = CKEDITOR.tools.keystrokeToString(
            ...
            "string" === typeof m ? c({ dataValue: m }) : a.getClipboardData(c);
          },
        };
      }
      function f() {
      ...
      function l(b, c) {
        ...
        if (!d.getById("cke_pastebin")) {
          ...
          var k = new CKEDITOR.dom.element(
            (!CKEDITOR.env.webkit && !e.is("body")) || CKEDITOR.env.ie
              ? "div"
              : "body",
            d,
          );
          ...
          CKEDITOR.env.webkit
            ? (e.append(k),
              ...
              e.is("body") ||
                ((h =
                  "static" != e.getComputedStyle("position")
                    ? e
                    : CKEDITOR.dom.element.get(e.$.offsetParent)),
                (h = h.getDocumentPosition().y)))
            : e.getAscendant(CKEDITOR.env.ie ? "body" : "html", 1).append(k);
          k.setStyles({
            position: "absolute",
          ...
          if (CKEDITOR.env.webkit || CKEDITOR.env.gecko)
            m = e.once("blur", g, null, null, -100);
          h && k.focus();
          h = new CKEDITOR.dom.range(k);
          h.selectNodeContents(k);
          var u = h.select();
          CKEDITOR.env.ie &&
            (m = e.once("blur", function () {
              a.lockSelection(u);
            }));
      ...
      function k(b) {
        ...
        e && p.canClipboardApiBeTrusted(c.dataTransfer, a)
          ? (b.data.preventDefault(),
            setTimeout(function () {
              r(a, c);
            }, 0))
      ...
      (function () {
        ...
        if (a.contextMenu) {
          a.contextMenu.addListener(function () {
            return { cut: q("cut"), copy: q("copy"), paste: q("paste") };
          });
          var c = null;
      ...
      a.getClipboardData = function (b, c) {
        ...
        !1 === t() &&
          ...
          a._.forcePasteDialog && g && a.fire("pasteDialog")
    ...
    function D(a) {
      ...
      a.on("contentDom", function () {
        function c(b, c, e) {
          c.select();
          r(a, { dataTransfer: e, method: "drop" }, 1);
        ...
        function f(b, c, e) {
          var d = { $: b.data.$, target: b.data.getTarget() };
          c && (d.dragRange = c);
          e && (d.dropRange = e);
          ...
          function () {
            ...
            CKEDITOR.env.ie &&
              ...
              ((b.dragStartContainerChildCount = c
                ? h(c.startContainer)
                : null),
              (b.dragEndContainerChildCount = c ? h(c.endContainer) : null));
          },
          null,
          null,
          100,
          ...
          function (e) {
            if ((e = e.data)) {
              ...
              l.getTransferType(a) == CKEDITOR.DATA_TRANSFER_INTERNAL
                ...
                : l.getTransferType(a) == CKEDITOR.DATA_TRANSFER_CROSS_EDITORS
                ? c(f, g, l)
                : d(g, l);
            }
          },
      ...
      init: function (a) {
          ...
          a.on(
            ...
            function (c) {
              ...
              if (
                ...
                "paste" == d.method &&
                b(l) &&
                ((l = l.getFile(0)), -1 != CKEDITOR.tools.indexOf(f, l.type))
              ) {
        ...
        a.on(
          ...
          function (a) {
            ...
            if (b.match(/^<[^<]+cke_(editable|contents)/i)) {
              var d,
                f,
                h = new CKEDITOR.dom.element("div");
              for (
                h.setHtml(b);
                1 == h.getChildCount() &&
                (d = h.getFirst()) &&
        ...
        a.on(
          ...
          function (b) {
            ...
            else if ((k && a.pasteFilter && !b.dontFilter) || n)
              f = w(a, f, a.pasteFilter);
    ...
    CKEDITOR.plugins.clipboard = {
      ...
      fixSplitNodesAfterDrop: function (a, b, c, d) {
        ...
        "number" == typeof d &&
          ...
          (f(a.startContainer, h, c) || f(a.endContainer, h, d));
      },
      ...
      internalDrop: function (a, b, c, d) {
        ...
        (g = this.isDropRangeAffectedByDragRange(a, b)) ||
        ...
        g = f.startNode;
        b &&
          a.getPosition(g) & CKEDITOR.POSITION_PRECEDING &&
          b.getPosition(g) & CKEDITOR.POSITION_FOLLOWING &&
          g.insertBefore(a);
        a = d.createRange();
        a.moveToBookmark(e);
        h.extractHtmlFromRange(a, 1);
        b = d.createRange();
        f.startNode.getCommonAncestor(h) ||
          (f = d.getSelection().createBookmarks()[0]);
        b.moveToBookmark(f);
        r(d, { dataTransfer: c, method: "drop", range: b }, 1);
        d.fire("unlockSnapshot");
      },
      getRangeAtDropPosition: function (a, b) {
        ...
        if (
          ...
          b.document.$.caretRangeFromPoint(d, f)
        )
          (c = b.document.$.caretRangeFromPoint(d, f)),
            ...
            try {
              ...
              if (g) {
                ...
                var q = b.document.$.elementFromPoint(d, f),
                  ...
                  r;
                if (p.equals(b.editable()) || "html" == p.getName())
                  return h &&
                    h.startContainer &&
                ...
                r = p.getClientRect();
                d < r.left
                  ? e.setStartAt(p, CKEDITOR.POSITION_AFTER_START)
                  : e.setStartAt(p, CKEDITOR.POSITION_BEFORE_END);
                e.collapse(!0);
              }
            } catch (v) {
              return null;
    ...
    n = CKEDITOR.plugins.clipboard.isCustomDataTypesSupported
      ? "cke/id"
      : "Text";
    CKEDITOR.plugins.clipboard.dataTransfer = function (a, b) {
      ...
      this.id ||
        (this.id = "Text" == n ? "" : "cke-" + CKEDITOR.tools.getUniqueId());
      b &&
        ((this.sourceEditor = b),
          ...
          if (this._isUnsupportedMimeTypeError(h)) {
            ...
            try {
              (d = this._applyDataComment(c, e)),
                f.setData(this._customDataFallbackType, d),
  ...
  (function () {
    function m(a) {
          ...
          function () {
            ...
            if (!b) {
              for (var f = 0; f < d.count(); f++)
                d.getItem(f).setCustomData("retain", !0);
              b = !0;
            }
          },
          null,
      ...
      if (b && !b.isDetached()) {
        ...
        (f = c.getElementById("cke_basetagscrpt")) &&
          ...
          this.attachListener(this, "keydown", function (a) {
            ...
            if (33 == c || 34 == c)
              if (CKEDITOR.env.ie)
                ...
                var d = b.createRange();
                d[33 == c ? "moveToElementEditStart" : "moveToElementEditEnd"](
                  this,
                );
                d.select();
                a.data.preventDefault();
      ...
      proto: {
        ...
        getData: function (a) {
          ...
          var e = a.config,
            ...
            f = this.getDocument(),
            b = b
              ? f.getDocumentElement().getOuterHtml()
              : f.getBody().getHtml();
          CKEDITOR.env.gecko &&
  ...
  (function () {
    ...
    function X(a, b) {
      function c(a, c) {
        var d = b.upcast.split(","),
          ...
          f;
        for (f = 0; f < d.length; f++)
          if (((e = d[f]), e === a.name)) return b.upcasts[e].call(this, a, c);
        return !1;
      }
      function d(b, c, d) {
    ...
    function T(a) {
      ...
      b.on("drop", function (c) {
        var e = c.data.dataTransfer,
          ...
          g = e.getTransferType(b),
          e = b.createRange();
        "" !== f && g === CKEDITOR.DATA_TRANSFER_CROSS_EDITORS
          ? c.cancel()
          : "" !== f &&
            g == CKEDITOR.DATA_TRANSFER_INTERNAL &&
            (f = a.instances[f]) &&
            ...
            c.data.dataTransfer.setData("text/html", f.getClipboardHtml()),
    ...
    function U(a) {
      function b(b) {
        1 > a.selected.length || F(c, "cut" === b.name);
      }
      var c = a.editor;
      c.on("contentDom", function () {
        var a = c.editable();
    ...
    function Q(a) {
      ...
      var c = a.editor;
      c.on("selectionCheck", b);
      c.on("contentDom", function () {
        c.editable().attachListener(c, "key", function () {
          setTimeout(b, 10);
        });
      });
      ...
      c.on("selectionChange", function (b) {
        ...
        f
          ? (f === e && f.focusedEditable.equals(b)) ||
            (p(a, f, null), e && b && p(a, e, b))
          : e && b && p(a, e, b);
      });
      c.on("dataReady", function () {
        G(a).commit();
    ...
    function N(a) {
      ...
      b.on("paste", function (a) {
        a = a.data;
        a.dataValue = a.dataValue.replace(ca, ba);
        a.range &&
      ...
      u.hasCopyBin(a) ||
        ((f = new u(a, {
          beforeDestroy: function () {
            ...
            e && CKEDITOR.plugins.widgetselection.addFillers(a.editable());
          },
          afterDestroy: function () {
            b &&
              !a.readOnly &&
              (d ? a.widgets.del(d) : a.extractSelectedHtml(),
              a.fire("saveSnapshot"));
          },
        })),
        d ||
          ...
          (g = a.getSelection().createBookmarks(!0))),
        f.handle(c()));
    }
    function I(a) {
    ...
    function V(a, b) {
      ...
      if (CKEDITOR.env.ie && 9 > CKEDITOR.env.version)
        a.wrapper.on("dragstart", function (b) {
          ...
          h.getNestedEditable(a, d) ||
            (a.inline && h.isDomDragHandler(d)) ||
            b.data.preventDefault();
        });
    ...
    function ha(a) {
      if (!0 === a.mask) la(a);
        ...
        var b = new CKEDITOR.tools.buffers.throttle(250, ma, a),
    ...
    function na(a) {
      function b() {
        var b;
        for (r.reset(); (b = h.pop()); ) b.removeListener();
        var c = k;
        b = a.sender;
    ...
    h.prototype = {
      ...
      destroyEditable: function (a, b) {
        var c = this.editables[a],
          d = !0;
        c.removeListener("focus", L);
        c.removeListener("blur", K);
      ...
      initEditable: function (a, b) {
        ...
        return c && c.is(CKEDITOR.dtd.$editable)
          ? ((c = new t(this.editor, c, {
            ...
            c.on("focus", L, this),
            CKEDITOR.env.ie && c.on("blur", K, this),
    ...
    var ca =
      ...
      M = { 37: 1, 38: 1, 39: 1, 40: 1, 8: 1, 46: 1 };
    M[CKEDITOR.SHIFT + 121] = 1;
    var u = CKEDITOR.tools.createClass({
      ...
      proto: {
        handle: function (a) {
          ...
          d.append(b);
          c.editable().append(d);
          p = c.on("selectionChange", J, null, null, 0);
          r = c.widgets.on("checkSelection", J, null, null, 0);
          e && (q = f.scrollTop);
  ...
  (function () {
            ...
            init: function () {
              if (this.editor.filter.check("figcaption")) {
                if (!this.parts.caption) {
                  ...
                  this.initEditable(
                    "caption",
                    this.definition.editables.caption,
                  );
                  a.caption = c;
                }
            ...
            _refreshCaption: function (b) {
              ...
              if (d)
                g.getData() || b.equals(f)
                  ? (!b ||
                      (b.equals(f) && b.data("cke-caption-placeholder"))) &&
                    c(this)
            ...
            setUp: function (a, b) {
              a.on("paste", function (d) {
                ...
                if (!a.readOnly && ("drop" === f || ("paste" === f && e))) {
                  ...
                  for (var k = 0; k < e; k++)
                    (f = g.getFile(k)),
                      CKEDITOR.fileTools.isTypeSupported(f, b.supportedTypes) &&
                        h.push(f);
                  h.length &&
                    (d.cancel(),
                    d.stop(),
          ...
          function b(a, c, b) {
            a.getCommand("unlink").on(c, function (c) {
              ...
              f &&
                l(f, "link") &&
                (c.stop(),
                b && "function" === typeof b && b(this, f, a),
                c.cancel());
            });
          }
          return {
      ...
      init: function (c) {
        r ||
          (CKEDITOR.document.appendStyleSheet(
            this.path + "styles/imagebase.css",
          ),
          (r = !0));
        c.addContentsCss &&
          c.addContentsCss(this.path + "styles/imagebase.css");
      },
    });
    CKEDITOR.plugins.imagebase = {
      ...
      addFeature: function (c, a, b) {
        ...
        c = CKEDITOR.tools.object.merge(b, f);
  ...
  CKEDITOR.config.plugins =
    "basicstyles,dialogui,dialog,notification,button,toolbar,clipboard,enterkey,entities,floatingspace,wysiwygarea,indent,indentlist,fakeobjects,link,list,undo,image,lineutils,widgetselection,widget,filetools,imagebase";
