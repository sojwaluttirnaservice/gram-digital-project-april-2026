  ...
  var g = function (b, d) {
    ...
    j = function (b, c) {
      ...
      return "string" == typeof b
        ? this[b].call(this, c)
        : void (g(this.scope).is("[" + this.attr_name() + "]")
            ? (g(this.scope).data(
          ...
          .on(
            ...
            function (d) {
              var e = c(this).closest("[" + b.attr_name() + "]"),
                ...
                g = c("dd > .content", e),
                h = a("dd", e),
                i = e.data(b.attr_name(!0) + "-init"),
                j = c("dd > .content." + i.active_class, e),
                k = c("dd." + i.active_class, e);
              if ((d.preventDefault(), c(this).closest("dl").is(e))) {
                if (i.toggleable && f.is(j))
                  return (
                    k.toggleClass(i.active_class, !1),
                    f.toggleClass(i.active_class, !1)
                  );
                i.multi_expand ||
                  (g.removeClass(i.active_class),
                  h.removeClass(i.active_class)),
  ...
  (function (a, b, c, d) {
    ...
    Foundation.libs.clearing = {
      ...
      events: function (d) {
        var e = this,
          f = e.S;
        a(".scroll-container").length > 0 &&
          (this.scope = a(".scroll-container")),
          f(this.scope)
            .off(".clearing")
            .on(
              "click.fndtn.clearing",
              "ul[" + this.attr_name() + "] li",
              function (a, b, c) {
                var b = b || f(this),
                  c = c || b,
                  d = b.next("li"),
      ...
      events: function () {
        ...
        d(this.scope)
          ...
          .on(
            ...
            function (a) {
              var b = d(this);
              if ((clearTimeout(c.timeout), b.data(c.data_attr())))
                var e = d("#" + b.data(c.data_attr())),
                  f = b;
              else {
                var e = b;
  ...
  (function (a, b, c, d) {
    ...
    Foundation.libs.joyride = {
      ...
      pos_default: function (c, d) {
        var e =
            (Math.ceil(a(b).height() / 2),
            this.settings.$next_tip.offset(),
            this.settings.$next_tip.find(".joyride-nub")),
  ...
  (function () {
    ...
    Foundation.libs.offcanvas = {
      ...
      events: function () {
        ...
        b(this.scope)
          .off(".offcanvas")
          .on("click.fndtn.offcanvas", ".left-off-canvas-toggle", function (b) {
          ...
          .on("click.fndtn.offcanvas", ".exit-off-canvas", function (b) {
            a.click_remove_class(b, "move-left"),
              a.click_remove_class(b, "move-right");
          });
      },
      click_toggle_class: function (a, b) {
        a.preventDefault(),
          this.S(a.target).closest(".off-canvas-wrap").toggleClass(b);
      },
        ...
        (m.cache = {}),
          ...
          (m._goto = function (a, b) {
            ...
            var i = function () {
              ...
              n.height() != h.height() && e.variable_height
                ? n.animate({ height: h.height() }, 250, "linear", d)
                : d();
            };
            ...
            h.height() > n.height() && e.variable_height
              ? n.animate({ height: h.height() }, 250, "linear", j)
              : j();
          }),
          (m.next = function (a) {
          ...
          (m.init = function () {
            ...
            h.on("click", "." + e.next_class, m.next),
              ...
              e.next_on_click &&
                h.on("click", "[data-orbit-slide]", m.link_bullet),
            ...
            a.extend(c, {
              success: function (b, c, i) {
                a.isFunction(h) && h(b, c, i),
                  ...
                  g.length > 0 && d.hide(g, f.css.close),
                  d.show(e, f.css.open);
              },
            }),
              a.ajax(c);
    ...
    Foundation.libs.tab = {
      ...
      init: function (a, b, c) {
        ...
        this.bindings(b, c),
          ...
          e("[" + this.attr_name() + "] > dd.active > a", this.scope).each(
            function () {
      ...
      toggle: function (c) {
        ...
        d.breakpoint() &&
          ...
          f.scrolltop
            ...
            : (d.is_sticky(e, e.parent(), f) && e.parent().addClass("fixed"),
              e.parent().hasClass("fixed") &&
                (e.hasClass("expanded")
                  ? (e.addClass("fixed"),
        ...
        e.detach(),
          c.S(".has-dropdown>a", e).each(function () {
            ...
            if (!e.find(".title.back").length) {
              if (d.mobile_show_parent_link && f && f.length > 1)
                var g = a(
              ...
              a("h5>a", g).html(
                1 == d.custom_back_text ? d.back_text : "&laquo; " + b.html(),
              ),
                e.prepend(g);
            }
          }),
