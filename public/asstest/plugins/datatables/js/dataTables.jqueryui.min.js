...
(function (a) {
  ...
  b.ext.renderer.header.jqueryui = function (d, f, g, h) {
    var k = "css_right ui-icon ui-icon-caret-2-n-s",
      n = -1 !== a.inArray("asc", g.asSorting),
      p = -1 !== a.inArray("desc", g.asSorting);
    g.bSortable && (n || p)
      ? n && !p
        ? (k = "css_right ui-icon ui-icon-caret-1-n")
        : !n && p && (k = "css_right ui-icon ui-icon-caret-1-s")
      : (k = "");
    a("<div/>")
      .addClass("DataTables_sort_wrapper")
      .append(f.contents())
      .append(a("<span/>").addClass(h.sSortIcon + " " + k))
      .appendTo(f);
    a(d.nTable).on("order.dt", function (l, q, r, m) {
      d === q &&
        ((l = g.idx),
        f
          .removeClass(h.sSortAsc + " " + h.sSortDesc)
          .addClass(
            "asc" == m[l]
              ? h.sSortAsc
              : "desc" == m[l]
